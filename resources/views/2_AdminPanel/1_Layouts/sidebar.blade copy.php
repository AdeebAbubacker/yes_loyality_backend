...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index" class="logo logo-dark">
            ...
            <span class="logo-lg">
                <img src="{{ URL::asset('2_AdminPanel/images//logo-dark.png') }}" alt="" height="17">
            </span>
        </a>
        <!-- Light Logo-->
        <a href="index" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="{{ URL::asset('2_AdminPanel/images//logo-light.png') }}" alt="" height="17">
            </span>
        </a>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                @php
                    $SidebarStructure_1 = config("sidebar");
                @endphp
                ...
                @foreach ($SidebarStructure_1 as $Entry_1)
                    ...
                    @elseif($Entry_1["Type"] == "List")
                        ...
                        if(isset($Entry_1["Href"]) && $Entry_1["Href"] != "") {
                            ...
                            $Href_1 = $IsRoute_1 ? Route($Entry_1["Href"]) : $Entry_1["Href"];
                        }
                        else {
                            $Href_1 = "#";
                        }
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link"{!! $LinkAttr_1 !!}>
                            ...
                            <div class="collapse menu-dropdown" id="sidebar{{ $Text_1 }}">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    if(isset($Entry_2["Href"]) && $Entry_2["Href"] != "") {
                                        ...
                                        $Href_2 = $IsRoute_2 ? Route($Entry_2["Href"]) : $Entry_2["Href"];
                                    }
                                    else {
                                        $Href_2 = "#";
                                    }
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="/template/dashboard-analytics" class="nav-link">@lang('translation.analytics')</a>
                            </li>
                            <li class="nav-item">
