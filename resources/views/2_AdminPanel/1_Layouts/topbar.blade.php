    ...
    <div class="layout-width">
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ URL::asset('2_AdminPanel/images//logo-sm.png') }}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ URL::asset('2_AdminPanel/images//logo-dark.png') }}" alt=""
                                height="17">
                        </span>
                    </a>
                    <a href="index" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ URL::asset('2_AdminPanel/images//logo-sm.png') }}" alt=""
                                height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ URL::asset('2_AdminPanel/images//logo-light.png') }}" alt=""
                                height="17">
                        </span>
                    </a>
                </div>
                            ...
                            <div data-simplebar style="max-height: 320px;">
                                ...
                                <div class="notification-list">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                        <div class="d-flex">
                                            <img src="{{ URL::asset('2_AdminPanel/images//users/avatar-2.jpg') }}"
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                        <div class="d-flex">
                                            <img src="{{ URL::asset('2_AdminPanel/images//users/avatar-3.jpg') }}"
                                                class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                        <div class="d-flex">
                                            <img src="{{ URL::asset('2_AdminPanel/images//users/avatar-5.jpg') }}"
                                                class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
            ...
            <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-1 topbar-head-dropdown header-item">
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                            ...
                            @switch(Session::get('lang'))
                                @case('ru')
                                    <img src="{{ URL::asset('2_AdminPanel/images//flags/russia.svg') }}" class="rounded"
                                        alt="Header Language" height="20">
                                @break

                                @case('it')
                                    <img src="{{ URL::asset('2_AdminPanel/images//flags/italy.svg') }}" class="rounded"
                                        alt="Header Language" height="20">
                                @break

                                @case('sp')
                                    <img src="{{ URL::asset('2_AdminPanel/images//flags/spain.svg') }}" class="rounded"
                                        alt="Header Language" height="20">
                                @break

                                @case('ch')
                                    <img src="{{ URL::asset('2_AdminPanel/images//flags/china.svg') }}" class="rounded"
                                        alt="Header Language" height="20">
                                @break

                                @case('fr')
                                    <img src="{{ URL::asset('2_AdminPanel/images//flags/french.svg') }}" class="rounded"
                                        alt="Header Language" height="20">
                                @break

                                @case('gr')
                                    <img src="{{ URL::asset('2_AdminPanel/images//flags/germany.svg') }}" class="rounded"
                                        alt="Header Language" height="20">
                                @break

                                @case('ae')
                                    <img src="{{ URL::asset('2_AdminPanel/images//flags/ae.svg') }}" class="rounded"
                                        alt="Header Language" height="20">
                                @break

                                @default
                                    <img src="{{ URL::asset('2_AdminPanel/images//flags/us.svg') }}" class="rounded"
                                        alt="Header Language" height="20">
                            @endswitch
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="{{ url('index/en') }}" class="dropdown-item notify-item language py-2"
                                ...
                                <img src="{{ URL::asset('2_AdminPanel/images//flags/us.svg') }}" alt="user-image"
                            ...
                            <a href="{{ url('index/sp') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('2_AdminPanel/images//flags/spain.svg') }}" alt="user-image"
                                    class="me-2 rounded" height="20">
                            ...
                            <a href="{{ url('index/gr') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('2_AdminPanel/images//flags/germany.svg') }}"
                                    alt="user-image" class="me-2 rounded" height="20"> <span
                            ...
                            <a href="{{ url('index/it') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('2_AdminPanel/images//flags/italy.svg') }}" alt="user-image"
                                    class="me-2 rounded" height="20">
                            ...
                            <a href="{{ url('index/ru') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('2_AdminPanel/images//flags/russia.svg') }}" alt="user-image"
                                    class="me-2 rounded" height="20">
                            ...
                            <a href="{{ url('index/ch') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('2_AdminPanel/images//flags/china.svg') }}" alt="user-image"
                                    class="me-2 rounded" height="20">
                            ...
                            <a href="{{ url('index/fr') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('2_AdminPanel/images//flags/french.svg') }}" alt="user-image"
                                    class="me-2 rounded" height="20">
                            ...
                            <a href="{{ url('index/ae') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('2_AdminPanel/images//flags/ae.svg') }}" alt="user-image"
                        ...
                        <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                            ...
                            <div class="p-2">
                                <div class="row g-0">
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#!">
                                            <img src="{{ URL::asset('2_AdminPanel/images//brands/github.png') }}"
                                                alt="Github">
                                            <span>GitHub</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#!">
                                            <img src="{{ URL::asset('2_AdminPanel/images//brands/bitbucket.png') }}"
                                                alt="bitbucket">
                                            <span>Bitbucket</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#!">
                                            <img src="{{ URL::asset('2_AdminPanel/images//brands/dribbble.png') }}"
                                                alt="dribbble">
                                            <span>Dribbble</span>
                                        </a>
                                    </div>
                                ...
                                <div class="row g-0">
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#!">
                                            <img src="{{ URL::asset('2_AdminPanel/images//brands/dropbox.png') }}"
                                                alt="dropbox">
                                            <span>Dropbox</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#!">
                                            <img src="{{ URL::asset('2_AdminPanel/images//brands/mail_chimp.png') }}"
                                                alt="mail_chimp">
                                    ...
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#!">
                                            <img src="{{ URL::asset('2_AdminPanel/images//brands/slack.png') }}"
                                                alt="slack">
                                            <span>Slack</span>
                                        </a>
                                    </div>
                            ...
                            <div data-simplebar style="max-height: 300px;">
                                <div class="p-2">
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ URL::asset('2_AdminPanel/images//products/img-1.png') }}"
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ URL::asset('2_AdminPanel/images//products/img-2.png') }}"
                                                class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                                    <a href="apps-ecommerce-product-details"
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ URL::asset('2_AdminPanel/images//products/img-3.png') }}"
                                                class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ URL::asset('2_AdminPanel/images//products/img-6.png') }}"
                                                class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                    ...
                                    <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ URL::asset('2_AdminPanel/images//products/img-5.png') }}"
                                                class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                            <div class="flex-1">
                                                <h6 class="mt-0 mb-1 fs-14">
                                                    <a href="apps-ecommerce-product-details"
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <button type="button" id="dark-mode-button" data-bs-toggle="tooltip" data-bs-placement="bottom"
                            ...
                            <div class="tab-content position-relative" id="notificationItemsTabContent">
                                <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        ...
                                        <div
                                            class="text-reset notification-item d-block dropdown-item position-relative">
                                            <div class="d-flex">
                                                <img src="{{ URL::asset('2_AdminPanel/images//users/avatar-8.jpg') }}"
                                                    class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                                                    <a href="#!" class="stretched-link">
                                ...
                                <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel"
                                    ...
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        ...
                                        <div class="text-reset notification-item d-block dropdown-item">
                                            <div class="d-flex">
                                                <img src="{{ URL::asset('2_AdminPanel/images//users/avatar-6.jpg') }}"
                                                    class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                <div class="flex-1">
                                                    <a href="#!" class="stretched-link">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            @endif
                            {{-- <img class="rounded-circle header-profile-user"
                                src="{{ URL::asset('storage/file_uploads/user/22/testimonial-3.jpg') }}"
                                alt="Header Avatar"> --}}
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        @if (Auth::user()->role_id != 1)
                            <a class="dropdown-item" href="{{ route('SupportPage') }}"><i
                                    class="mdi mdi-lifebuoy text-muted fs-16 align-middle me-1"></i> <span
                                    class="align-middle">Get Support</span></a>
                        @endif
                        ...
                        {{-- <a class="dropdown-item" href="{{ route('EditProfile') }}"><span
