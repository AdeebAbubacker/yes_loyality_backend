@php
    ...
    if ($OfferEdit):
        if (isset($duplicate)):
            $route = 'AddLoyalityOffer';
            $multiSelect = 'data-choices-removeItem multiple';
            $name = 'branch_id[]';
            $OfferStatus = 0;
        else:
            $route = 'EditLoyalityOffer';
            $OfferId = $Offer->id;
            $multiSelect = '';
            $name = 'branch_id';
        ...
        $OfferMaxReduction = $Offer->max_reduction;
        $OfferPoints = $Offer->points_required;
        $OfferDiscount = $Offer->discount_val;
...
<form action="{{ route($route) }}" method="POST" id="CommonForm" enctype="multipart/form-data">
    ...
    <div class="row g-3">
        <div class="col-md-6">
            <div>
                <label for="branch_id" class="form-label">Branch <span class="required-indicator">*</span></label>
        ...
        <div class="col-md-6">
            <div>
                <label for="title" class="form-label">Loyalty Offer Name <span
                        class="required-indicator">*</span></label>
                <input type="text" class="form-control" id="name" name="name"
                    placeholder="Enter Loyalty Offer Name" value="{{ $OfferName ?? null }}" {{ $disabled ?? null }} />
            </div>
        </div>
        <div class="col-md-12">
            <div>
                <label for="comment" class="form-label">Description<span class="required-indicator">*</span></label>
                <textarea type="text" class="form-control" id="comment" name="comment" placeholder="Enter Description"
                    {{ $disabled ?? null }} style="min-height:100px">{{ $OfferComment ?? null }}</textarea>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div>
                <label for="discount_val" class="form-label">Discount Value <span
                        class="required-indicator">*</span></label>
                <input type="number" min="0" class="form-control" id="discount_val" name="discount_val"
                    placeholder="Enter Points" value="{{ $OfferDiscount ?? null }}" {{ $disabled ?? null }} />
            </div>
        </div>
        <div class="col-md-6">
            <div>
                <label for="discount_type" class="form-label">Discount Type <span
                        class="required-indicator">*</span></label>
                <select class="form-select" id="discount_type" name="discount_type" data-choices
                    {{ $disabled ?? null }}>
        ...
        <div class="col-md-6">
            <div>
                <label for="min_inv_amt" class="form-label">Minimum Purchase Amount <span
                        class="required-indicator">*</label>
                <input type="number" class="form-control" id="min_inv_amt" name="min_inv_amt"
        ...
        <div class="col-md-6">
            <div>
                <label for="max_reduction" class="form-label">Maximum Redeemable Amount </label>
                <input type="number" class="form-control" id="max_reduction" name="max_reduction"
                    placeholder="Enter Maximum Amount" value="{{ $OfferMaxReduction ?? null }}"
                    {{ $disabled ?? null }} />
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div>
                <label for="points_required" class="form-label">Points Required<span
                        class="required-indicator">*</label>
                <input type="number" class="form-control" id="points_required" name="points_required"
                    placeholder="Enter Points" value="{{ $OfferPoints ?? null }}" {{ $disabled ?? null }} />
            </div>
        </div>
        <div class="col-md-4">
            <div>
        ...
        <div class="col-md-4">
            <div>
                <label for="expiry_end" class="form-label">Valid To</label>
                <input type="text" class="form-control" data-provider="flatpickr" id="expiry_end"
                    name="expiry_end" placeholder="Enter Expiry Ends" value="{{ $OfferEends ?? null }}"
                    {{ $disabled ?? null }} />
            </div>
        </div>
