...
<div class="booking-area pt-50 pb-50">
    <div class="container">
        <div class="form-wrapper">
            <form method="POST" action="{{ Route('UpdateBookings') }}" id="TravelBookingForm">
                @csrf
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="address" id="addr" cols="45" rows="3" maxlength="65525" class="form-control"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="traveller_wrap" id="traveller_wrap">
                        ...
                        <div class="row" id="main_traveller_info">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="traveller_name[]"
                                                class="form-control" value="" id="main_traveller"
                                                readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" aria-label="Default select"
                                                name="traveller_gender[]" id="traveller_gender">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="traveller_aadhaar[]"
                                                id="traveller_aadhar" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            <label for="same_gender">Prefer to be seated with the same
                                                gender</label>
