                                ...
                                <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="{{ URL::asset('2_AdminPanel/images/products/img-8.png') }}" alt=""
                                                class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ URL::asset('2_AdminPanel/images/products/img-6.png') }}" alt=""
                                                class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ URL::asset('2_AdminPanel/images/products/img-1.png') }}" alt=""
                                                class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="{{ URL::asset('2_AdminPanel/images/products/img-8.png') }}" alt=""
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="#" class="d-block">
                                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-12.jpg') }}"
                                                                            alt=""
                                                                            class="avatar-sm rounded object-cover">
                                                                    </a>
                                                                    <a href="#" class="d-block">
                                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-11.jpg') }}"
                                                                            alt=""
                                                                            class="avatar-sm rounded object-cover">
                                                                    </a>
                                                                    <a href="#" class="d-block">
                                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-10.jpg') }}"
                                                                            alt=""
                                                                            class="avatar-sm rounded object-cover">
                                                                    </a>
                                                                </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/ecommerce-product-details.init.js') }}"></script>
