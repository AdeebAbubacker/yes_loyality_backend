                                    ...
                                    <div class="col-md-auto">
                                        <div class="avatar-md">
                                            <div class="avatar-title bg-white rounded-circle">
                                                <img src="{{ URL::asset('2_AdminPanel/images/brands/slack.png') }}" alt="" class="avatar-xs">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        ...
                                        <div class="d-flex mb-4">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-10.jpg') }}" alt=""
                                                            class="avatar-xs rounded-circle" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="row">
                                            <div class="col-xxl-4">
                                                <div class="row border border-dashed gx-2 p-2 mb-2">
                                                    <div class="col-4">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt=""
                                                            class="img-fluid rounded" />
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-4">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt=""
                                                            class="img-fluid rounded" />
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-4">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-4 d-flex align-items-center">
                        ...
                        <div class="avatar-group justify-content-center">
                            ...
                            <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip"
                                ...
                                <div class="avatar-xs">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle img-fluid">
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="mx-n4 px-4" data-simplebar style="max-height: 225px;">
                        <div class="vstack gap-3">
                            <div class="d-flex align-items-center">
                                <div class="avatar-xs flex-shrink-0 me-3">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" alt="" class="img-fluid rounded-circle">
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar-xs flex-shrink-0 me-3">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt="" class="img-fluid rounded-circle">
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar-xs flex-shrink-0 me-3">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-7.jpg') }}" alt="" class="img-fluid rounded-circle">
                                </div>
                                <div class="flex-grow-1">
...
@endsection
@section('script')
    <script src="{{ URL::asset('2_AdminPanel/js/pages/project-overview.init.js') }}"></script>
