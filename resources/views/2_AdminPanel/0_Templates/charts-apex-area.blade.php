                ...
                <div>
                    ...
                    <div class="github-style d-flex align-items-center my-2">
                        <div class="flex-shrink-0 me-2">
                            <img class="avatar-sm rounded" src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" data-hovercard-user-id="634573" alt="" />
                        </div>
...
<script src="{{ URL::asset('2_AdminPanel/libs/moment/moment.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/js/pages/apexcharts-area.init.js') }}"></script>
