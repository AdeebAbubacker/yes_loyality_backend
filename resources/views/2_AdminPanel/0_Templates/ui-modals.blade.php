                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('2_AdminPanel/images/modals/success-payment.png') }}"
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('2_AdminPanel/images/modals/login.png') }}"
                                            alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('2_AdminPanel/images/modals/subscribe.png') }}"
                                            alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="subscribe-modals-cover h-100">
                                            <img src="{{ URL::asset('2_AdminPanel/images/modals/auth-one-bg.jpg') }}"
                                                alt="" class="h-100 w-100 object-cover"
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('2_AdminPanel/images/modals/signup.png') }}"
                                            alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/modal.init.js') }}"></script>
