                            ...
                            <div class="col-xl-7">
                                <div class="row justify-content-between">
                                    <div class="col-lg-5 col-sm-6">
                                        <div class="card">
                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" class="card-img-top" alt="card img">
                                    ...
                                    <div class="col-lg-5 col-sm-6">
                                        <div class="card" aria-hidden="true">
                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" class="card-img-top" alt="card dummy img">
                                            <div class="card-body">
