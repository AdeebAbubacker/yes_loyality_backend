                        ...
                        <div class="live-preview">
                            <nav id="navbar-example" class="navbar navbar-dark bg-light px-3">
                                <a class="navbar-brand" href="#">
                                    <img src="{{ URL::asset('2_AdminPanel/images/logo-dark.png') }}" class="card-logo card-logo-dark" alt="logo dark" height="14">
                                    <img src="{{ URL::asset('2_AdminPanel/images/logo-light.png') }}" class="card-logo card-logo-light" alt="logo light" height="14">
                                </a>
                            ...
                            <div class="col-xxl-3">
                                <nav id="navbar-examplenested" class="navbar navbar-dark bg-light flex-column">
                                    <a class="navbar-brand mb-2" href="#">
                                        <img src="{{ URL::asset('2_AdminPanel/images/logo-dark.png') }}" class="card-logo card-logo-dark" alt="logo dark" height="15">
                                        <img src="{{ URL::asset('2_AdminPanel/images/logo-light.png') }}" class="card-logo card-logo-light" alt="logo light" height="15">
                                    </a>
