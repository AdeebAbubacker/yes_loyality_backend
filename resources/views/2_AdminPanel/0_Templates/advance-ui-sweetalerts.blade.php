                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('2_AdminPanel/images/sweetalert2/success-message.png') }}" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('2_AdminPanel/images/sweetalert2/error-message.png') }}" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('2_AdminPanel/images/sweetalert2/warning-message.png') }}" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('2_AdminPanel/images/sweetalert2/join-community.png') }}" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('2_AdminPanel/images/sweetalert2/email-verify.png') }}" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="{{ URL::asset('2_AdminPanel/images/sweetalert2/notification-message.png') }}" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/sweetalerts.init.js') }}"></script>
