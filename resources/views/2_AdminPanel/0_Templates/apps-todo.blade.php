...
@endsection
@section('css')
<link href="{{ URL::asset('2_AdminPanel/libs/dragula/dragula.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="file-manager-sidebar">
        <div class="p-4 d-flex flex-column h-100">
            ...
            <div class="mt-auto text-center">
                <img src="{{URL::asset('2_AdminPanel/images/task.png')}}" alt="Task" class="img-fluid" />
            </div>
        </div>
    </div>
    <!--end side content-->
                                ...
                                <div data-simplebar style="max-height: 141px">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-1.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-6.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-9.jpg')}}" alt="" class="img-fluid rounded-circle" />
                                                </div>
...
<script src="{{URL::asset('2_AdminPanel/js/pages/todo.init.js')}}"></script>
