                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-xs me-2 flex-shrink-0">
                                            <div class="avatar-title bg-soft-secondary rounded">
                                                <img src="{{URL::asset('2_AdminPanel/images/companies/img-1.png')}}" alt="" height="16">
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-xs me-2 flex-shrink-0">
                                            <div class="avatar-title bg-soft-warning rounded">
                                                <img src="{{URL::asset('2_AdminPanel/images/companies/img-3.png')}}" alt="" height="16">
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-xs me-2 flex-shrink-0">
                                            <div class="avatar-title bg-soft-primary rounded">
                                                <img src="{{URL::asset('2_AdminPanel/images/companies/img-2.png')}}" alt="" height="16">
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-xs me-2 flex-shrink-0">
                                            <div class="avatar-title bg-soft-danger rounded">
                                                <img src="{{URL::asset('2_AdminPanel/images/companies/img-4.png')}}" alt="" height="16">
                                            </div>
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-xs me-2 flex-shrink-0">
                                            <div class="avatar-title bg-soft-danger rounded">
                                                <img src="{{URL::asset('2_AdminPanel/images/companies/img-5.png')}}" alt="" height="16">
                                            </div>
                                        </div>
                            ...
                            <ul class="list-unstyled mb-0 pt-2" id="candidate-list">
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-9.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-8.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                ...
                <div class="col-lg-6">
                    <div class="card-body text-center">
                        <div class="avatar-md mb-3 mx-auto">
                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jpg')}}" alt="" id="candidate-img" class="img-thumbnail rounded-circle shadow-none">
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-2">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-8.jpg')}}" alt="" class="avatar-xs rounded-circle" />
                                        </div>
...
<!-- Dashboard init -->
<script src="{{URL::asset('2_AdminPanel/js/pages/dashboard-job.init.js')}}"></script>
