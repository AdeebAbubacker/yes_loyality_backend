                                ...
                                <div data-simplebar style="height: calc(100vh - 112px);">
                                    <div class="acitivity-timeline p-4">
                                        <div class="acitivity-item d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                            </div>
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="avatar-group mb-2">
                                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt="" class="rounded-circle avatar-xs">
                                                    </a>
                                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" alt="" class="rounded-circle avatar-xs">
                                                    </a>
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <div class="row border border-dashed gx-2 p-2 mb-2">
                                                    <div class="col-4">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt="" class="img-fluid rounded" />
                                                    </div>
                                                    <div class="col-4">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="" class="img-fluid rounded" />
                                                    </div>
                                                    <div class="col-4">
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="acitivity-item d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-8.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
