                        ...
                        <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>Absternet LLC</td>
                                    <td>Sep 20, 2021</td>
                                    <td><img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>Raitech Soft</td>
                                    <td>Sep 23, 2021</td>
                                    <td><img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>William PVT</td>
                                    <td>Sep 27, 2021</td>
                                    <td><img src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>Loiusee LLP</td>
                                    <td>Sep 30, 2021</td>
                                    <td><img src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-circle me-2">
                                ...
                                <tr>
                                    <td>Apple Inc.</td>
                                    <td>Sep 30, 2021</td>
                                    <td><img src="{{ URL::asset('2_AdminPanel/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle me-2">
                                        <a href="#javascript: void(0);" class="text-body fw-medium">Vitoria Rodrigues</a></td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>William PVT</td>
                                    <td><img src="{{ URL::asset('2_AdminPanel/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle me-2">
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/dashboard-crm.init.js') }}"></script>
