...
@section('css')
    <link href="{{ URL::asset('2_AdminPanel/libs/leaflet/leaflet.css') }}" rel="stylesheet" type="text/css" />
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/libs/leaflet/leaflet.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/js/pages/leaflet-us-states.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/js/pages/leaflet-map.init.js') }}"></script>
