                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-02.jpg')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="apps-nft-item-details">
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-1.jpg')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-3.jpg')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-5.jpg')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jp')}}g" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-8.jpg')}}" alt="" class="avatar-sm object-cover rounded-circle">
                                        <div class="ms-2">
                                            <a href="#!">
...
@endsection
@section('script')
<script src="{{ URL::asset('2_AdminPanel/js/pages/apps-nft-auction.init.js') }}"></script>
