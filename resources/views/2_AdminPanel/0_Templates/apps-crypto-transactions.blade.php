                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/eur.svg') }}" alt="" class="avatar-xxs me-2">
                                    EUR
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/gbp.svg') }}" alt="" class="avatar-xxs me-2">
                                    GBP
                                </div>
                            </td>
                            <td class="form_name">Wallet</td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/jpy.svg') }}" alt="" class="avatar-xxs me-2">
                                    JPY
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/xpm.svg') }}" alt="" class="avatar-xxs me-2">
                                    XPM
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/ppt.svg') }}" alt="" class="avatar-xxs me-2">
                                    PPT
                                </div>
                            </td>
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/crypto-transactions.init.js') }}"></script>
