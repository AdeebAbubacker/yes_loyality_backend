                    ...
                    <div class="mt-2 vstack email-chat-list mx-n4">
                        <a href="javascript: void(0);" class="d-flex align-items-center active">
                            <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" alt="">
                            </div>
                        ...
                        <a href="javascript: void(0);" class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt="">
                            </div>
                        ...
                        <a href="javascript: void(0);" class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" alt="">
                            </div>
                        ...
                        <a href="javascript: void(0);" class="d-flex align-items-center">
                            <div class="flex-shrink-0 me-2 avatar-xxs chatlist-user-image">
                                <img class="img-fluid rounded-circle" src="{{ URL::asset('2_AdminPanel/images/users/avatar-5.jpg') }}" alt="">
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex gap-3">
                                        <div class="border rounded avatar-xl h-auto">
                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt="" class="img-fluid rouned-top">
                                            <div class="py-2 text-center">
                                                <a href="" class="d-block fw-semibold">Download</a>
                                            </div>
                                        </div>
                                        <div class="border rounded avatar-xl h-auto">
                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" alt="" class="img-fluid rouned-top">
                                            <div class="py-2 text-center">
                                                <a href="" class="d-block fw-semibold">Download</a>
                                            </div>
                                        </div>
...
@endsection
@section('script')
<script src="{{ URL::asset('2_AdminPanel/libs/@ckeditor/ckeditor5-build-classic/2_AdminPanel/ckeditor.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/js/pages/mailbox.init.js') }}"></script>
