                                            ...
                                            <div class="ctext-wrap">
                                                <div class="message-img mb-0">
                                                    <div class="message-img-list">
                                                        <div>
                                                            <a class="popup-img d-inline-block"
                                                                href="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}">
                                                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}"
                                                    ...
                                                    <div class="message-img-list">
                                                        <div>
                                                            <a class="popup-img d-inline-block"
                                                                href="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}">
