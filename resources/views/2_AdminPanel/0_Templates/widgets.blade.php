    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-height-100">
            <div class="card-body">
                ...
                <div class="mb-4 pb-2">
                    <img src="{{URL::asset('2_AdminPanel/images/companies/img-3.png')}}" alt="" class="avatar-sm">
                </div>
                <a href="#!">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-height-100">
            <div class="card-body">
                ...
                <div class="mb-4 pb-2">
                    <img src="{{URL::asset('2_AdminPanel/images/companies/img-4.png')}}" alt="" class="avatar-sm">
                </div>
                <a href="#!">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-height-100 bg-soft-primary shadow-none bg-opacity-10">
            <div class="card-body">
                ...
                <div class="mb-4 pb-2">
                    <img src="{{URL::asset('2_AdminPanel/images/companies/img-6.png')}}" alt="" class="avatar-sm">
                </div>
                <a href="#!">
                    <h6 class="fs-15 fw-semibold">Sr. Web Designer <span class="text-muted fs-13">(2+ Yrs Exp.)</span></h6>
                </a>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card card-height-100 bg-soft-info shadow-none bg-opacity-10">
            <div class="card-body">
                ...
                <div class="mb-4 pb-2">
                    <img src="{{URL::asset('2_AdminPanel/images/companies/img-8.png')}}" alt="" class="avatar-sm">
                </div>
                <a href="#!">
                    <h6 class="fs-15 fw-semibold">Sr. Web Designer <span class="text-muted fs-13">(2+ Yrs Exp.)</span></h6>
                </a>
        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-sm-4">
                        <div class="px-3">
                            <img src="{{URL::asset('2_AdminPanel/images/user-illustarator-2.png')}}" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div> <!-- end card-body-->
        ...
        <div class="card bg-primary">
            <div class="card-body p-0">
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-sm-4">
                        <div class="px-3">
                            <img src="{{URL::asset('2_AdminPanel/images/user-illustarator-1.png')}}" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div> <!-- end card-body-->
                                ...
                                <div class="avatar-group">
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-1.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                        </a>
                                    </div>
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Jansh Brown">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-2.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                        </a>
                                    </div>
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Dan Gibson">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-3.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                        </a>
                                    </div>
                                    <div class="avatar-group-item">
                                ...
                                <div class="avatar-group">
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Frida Bang">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-4.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                        </a>
                                    </div>
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Malou Silva">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-5.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                        </a>
                                    </div>
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Simon Schmidt">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-6.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                        </a>
                                    </div>
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Tosh Jessen">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-7.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                        </a>
                                    </div>
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);">
                                ...
                                <div class="avatar-group">
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Nina Schmidt">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-8.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                        </a>
                                    </div>
                                    <div class="avatar-group-item">
                                        <a href="javascript: void(0);" class="d-inline-block" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Stine Nielsen">
                    ...
                    <div class="card-body p-0">
                        <div data-simplebar style="max-height: 364px;" class="p-3">
                            <div class="acitivity-timeline acitivity-main">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2 w-75">
                                            <a href="apps-ecommerce-product-details" class="bg-light rounded p-1">
                                                <img src="{{URL::asset('2_AdminPanel/images/products/img-8.png')}}" alt="" class="img-fluid d-block" />
                                            </a>
                                            <a href="apps-ecommerce-product-details" class="bg-light rounded p-1">
                                                <img src="{{URL::asset('2_AdminPanel/images/products/img-2.png')}}" alt="" class="img-fluid d-block" />
                                            </a>
                                            <a href="apps-ecommerce-product-details" class="bg-light rounded p-1">
                                                <img src="{{URL::asset('2_AdminPanel/images/products/img-10.png')}}" alt="" class="img-fluid d-block" />
                                            </a>
                                        </div>
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-2.jpg')}}" alt="" class="avatar-xs rounded-circle acitivity-avatar">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                ...
                                <div class="acitivity-item d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-3.jpg')}}" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                ...
                <ul class="list-group list-group-flush border-dashed mb-0">
                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0 avatar-xs">
                                <span class="avatar-title bg-light p-1 rounded-circle">
                                    <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/btc.svg')}}" class="img-fluid" alt="">
                                </span>
                            </div>
                    ...
                    <li class="list-group-item px-0">
                        <div class="d-flex">
                            <div class="flex-shrink-0 avatar-xs">
                                <span class="avatar-title bg-light p-1 rounded-circle">
                                    <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/eth.svg')}}" class="img-fluid" alt="">
                                </span>
                            </div>
                            <div class="flex-grow-1 ms-2">
                    ...
                    <li class="list-group-item px-0">
                        <div class="d-flex">
                            <div class="flex-shrink-0 avatar-xs">
                                <span class="avatar-title bg-light p-1 rounded-circle">
                                    <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/ltc.svg')}}" class="img-fluid" alt="">
                                </span>
                            </div>
                            <div class="flex-grow-1 ms-2">
                    ...
                    <li class="list-group-item px-0 pb-0">
                        <div class="d-flex">
                            <div class="flex-shrink-0 avatar-xs">
                                <span class="avatar-title bg-light p-1 rounded-circle">
                                    <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/dash.svg')}}" class="img-fluid" alt="">
                                </span>
                            </div>
                            <div class="flex-grow-1 ms-2">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-info rounded">
                                    <img src="{{URL::asset('2_AdminPanel/images/products/img-3.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-success rounded">
                                    <img src="{{URL::asset('2_AdminPanel/images/products/img-4.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                                    <h5 class="text-secondary">$99.94</h5>
                                    <a href="#!">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-warning rounded">
                                    <img src="{{URL::asset('2_AdminPanel/images/products/img-5.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                                    <h5 class="text-secondary">$99.94</h5>
                                    <a href="#!">
                        ...
                        <div class="swiper-slide" style="max-width: 200px;">
                            <div>
                                <div class="bg-soft-secondary rounded">
                                    <img src="{{URL::asset('2_AdminPanel/images/products/img-6.png')}}" alt="" style="max-height: 210px;max-width: auto;" />
                                </div>
                                <div class="pt-3">
                                    <h5 class="text-secondary">$99.94</h5>
                                    <a href="#!">
                ...
                <div class="d-flex align-items-center mb-3">
                    <div class="avatar-sm me-3 flex-shrink-0">
                        <div class="avatar-title bg-soft-info rounded">
                            <img src="{{URL::asset('2_AdminPanel/images/products/img-6.png')}}" alt="" class="avatar-xs">
                        </div>
                    </div>
                    <div class="flex-grow-1">
                ...
                <div class="d-flex align-items-center mb-3">
                    <div class="avatar-sm me-3 flex-shrink-0">
                        <div class="avatar-title bg-soft-danger rounded">
                            <img src="{{URL::asset('2_AdminPanel/images/products/img-8.png')}}" alt="" class="avatar-xs">
                        </div>
                    </div>
                    <div class="flex-grow-1">
                        <p class="text-muted mb-2">Adidas</p>
                            ...
                            <ul class="list-unstyled mb-0 pt-2" id="candidate-list">
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-1.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-2.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-3.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-4.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="d-flex align-items-center py-2">
                                        <div class="flex-shrink-0 me-2">
                                            <div class="avatar-xs">
                                                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-5.jpg')}}" alt="" class="img-fluid rounded-circle candidate-img">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1">
                ...
                <div class="col-lg-6">
                    <div class="card-body text-center">
                        <div class="avatar-md mb-3 mx-auto">
                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-1.jpg')}}" alt="" id="candidate-img" class="img-thumbnail rounded-circle shadow-none">
                        </div>
...
<script src="{{ URL::asset('2_AdminPanel/libs/jsvectormap/maps/us-merc-en.js') }}"></script>
<!-- Swiper Js -->
<script src="{{URL::asset('2_AdminPanel/libs/swiper/swiper-bundle.min.js')}}"></script>

<script src="{{URL::asset('2_AdminPanel/js/pages/form-input-spin.init.js')}}"></script>

<script src="{{URL::asset('2_AdminPanel/libs/card/card.js')}}"></script>

<!-- Widget init -->
<script src="{{ URL::asset('2_AdminPanel/js/pages/widgets.init.js') }}"></script>
