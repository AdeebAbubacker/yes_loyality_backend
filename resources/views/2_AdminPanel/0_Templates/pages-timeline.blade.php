                              ...
                              <div class="col-12">
                                  <div class="timeline-box">
                                      <div class="timeline-text">
                                          ...
                                          <div class="row border border-dashed rounded gx-2 p-2">
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="{{ URL::asset('2_AdminPanel/images/small/img-10.jpg') }}" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                              <div class="col-3">
                                                  <a href="javascript:void(0);"><img src="{{ URL::asset('2_AdminPanel/images/small/img-9.jpg') }}" alt="" class="img-fluid rounded"></a>
                                              </div><!--end col-->
                                          </div>
                                      </div>
                                  </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/timeline.init.js') }}"></script>
