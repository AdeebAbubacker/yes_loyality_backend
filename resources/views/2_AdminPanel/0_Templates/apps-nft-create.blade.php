...
@section('css')
<!-- Filepond css -->
<link href="{{ URL::asset('2_AdminPanel/libs/filepond/filepond.min.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ URL::asset('2_AdminPanel/libs/filepond-plugin-image-preview/filepond-plugin-image-preview.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
<script src="{{ URL::asset('2_AdminPanel/libs/filepond-plugin-image-preview/filepond-plugin-image-preview.min.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/libs/filepond-plugin-file-validate-size/filepond-plugin-file-validate-size.min.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/libs/filepond-plugin-image-exif-orientation/filepond-plugin-image-exif-orientation.min.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/libs/filepond-plugin-file-encode/filepond-plugin-file-encode.min.js') }}"></script>
<!--nft create init js-->
<script src="{{ URL::asset('2_AdminPanel/js/pages/apps-nft-create.init.js') }}"></script>
