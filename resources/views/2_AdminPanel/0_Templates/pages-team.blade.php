                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="px-1 pt-1">
                                            <div class="modal-team-cover position-relative mb-0 mt-n4 mx-n4 rounded-top overflow-hidden">
                                                <img src="{{URL::asset('2_AdminPanel/images/small/img-9.jpg')}}" alt="" id="cover-img" class="img-fluid">
                                            ...
                                            <div class="position-relative d-inline-block">
                                                ...
                                                <div class="avatar-lg">
                                                    <div class="avatar-title bg-light rounded-circle">
                                                        <img src="{{URL::asset('2_AdminPanel/images/users/user-dummy-img.jpg')}}" id="member-img" class="avatar-md rounded-circle h-auto" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
@endsection
@section('script')
<script src="{{ URL::asset('2_AdminPanel/js/pages/team.init.js') }}"></script>
