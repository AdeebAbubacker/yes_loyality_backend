    ...
    <div class="col-xl-3 col-lg-4 col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-shrink-0">
                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                    </div>
                    <div class="ms-3 flex-grow-1">
                        <a href="pages-profile">
...
<div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
    <div class="col">
        <div class="card">
            <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="object-cover card-img-top" height="120">
            <div class="card-body text-center">
                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-2.jpg')}}" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-6.jpg')}}" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="object-cover card-img-top" height="120">
            <div class="card-body text-center">
                <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="object-cover card-img-top" height="120">
            <div class="card-body text-center">
    ...
    <div class="col">
        <div class="card">
            <img src="https://img.themesbrand.com/velzon/images/img-3.gif" alt="" class="object-cover card-img-top" height="120">
            <div class="card-body text-center">
                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-8.jpg')}}" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            <img src="{{URL::asset('2_AdminPanel/images/nft/img-01.jpg')}}" alt="" class="object-cover card-img-top" height="120">
            <div class="card-body text-center">
                <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jpg')}}" alt="" class="avatar-md rounded-circle object-cover mt-n5 img-thumbnail border-light border-5 border-white mx-auto d-block">
                <a href="pages-profile">
