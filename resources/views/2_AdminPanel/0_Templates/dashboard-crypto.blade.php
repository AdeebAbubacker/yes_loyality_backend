...
@section('css')
    ...
    <link href="{{ URL::asset('2_AdminPanel/libs/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
                    ...
                    <ul class="list-group list-group-flush border-dashed mb-0 mt-3 pt-2">
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/btc.svg') }}"
                                            class="img-fluid" alt="">
                                    </span>
                                </div>
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/eth.svg') }}"
                                            class="img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="flex-grow-1 ms-2">
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/ltc.svg') }}"
                                            class="img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="flex-grow-1 ms-2">
                        ...
                        <li class="list-group-item px-0 pb-0">
                            <div class="d-flex">
                                <div class="flex-shrink-0 avatar-xs">
                                    <span class="avatar-title bg-light p-1 rounded-circle">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/dash.svg') }}"
                                            class="img-fluid" alt="">
                                    </span>
                                </div>
                                <div class="flex-grow-1 ms-2">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/etc.svg') }}"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/bnb.svg') }}"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/usdt.svg') }}"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/neo.svg') }}"
                                        class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/btc.svg') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/ltc.svg') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/eth.svg') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/bnb.svg') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/neo.svg') }}" alt=""
                                                    class="avatar-xxs">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/doge.svg') }}"
                                                    alt="" class="avatar-xxs">
                                            </div>
                                            <div>
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush border-dashed mb-0">
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/btc.svg') }}" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/eth.svg') }}" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/aave.svg') }}" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/doge.svg') }}" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/bnb.svg') }}" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/ltc.svg') }}" class="avatar-xs"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-middle">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" class="rounded img-fluid"
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" class="rounded img-fluid"
                                style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" class="rounded img-fluid"
                                style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" class="rounded img-fluid"
                                style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/dashboard-crypto.init.js') }}"></script>
