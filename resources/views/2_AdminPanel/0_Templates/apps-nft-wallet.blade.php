...
<div class="row justify-content-center">
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="{{URL::asset('2_AdminPanel/images/nft/wallet/kukai.png')}}" alt="" height="55" class="mb-3 pb-2">
                <h5>Kukai Wallet</h5>
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="{{URL::asset('2_AdminPanel/images/nft/wallet/enjin.png')}}" alt="" height="55" class="mb-3 pb-2">
                <h5>Enjin Wallet</h5>
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="{{URL::asset('2_AdminPanel/images/nft/wallet/alpha.png')}}" alt="" height="55" class="mb-3 pb-2">
                <h5>Alpha Wallet</h5>
    ...
    <div class="col-lg-3">
        <div class="card text-center">
            <div class="card-body py-5 px-4">
                <img src="{{URL::asset('2_AdminPanel/images/nft/wallet/math.png')}}" alt="" height="55" class="mb-3 pb-2">
                <h5>Math Wallet</h5>
