...
<link href="{{ URL::asset('2_AdminPanel/libs/nouislider/nouislider.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
...
<script src="{{ URL::asset('2_AdminPanel/js/pages/apps-nft-explore.init.js') }}"></script>
