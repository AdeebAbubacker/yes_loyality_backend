                                        ...
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="james-forbes">
                                                <span class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="john-robles">
                                                <span class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="mary-gant">
                                                <span class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="curtis-saenz">
                                                <span class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="virgie-price">
                                                <span class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-5.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="anthony-mills">
                                                <span class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-10.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="marian-angel">
                                                <span class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-6.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="johnnie-walton">
                                                <span class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-7.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="donna-weston">
                                                <span class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-8.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
                                    ...
                                    <li>
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="form-check-label d-flex align-items-center" for="diego-norris">
                                                <span class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-9.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                </span>
...
<script src="{{ URL::asset('2_AdminPanel/js/pages/tasks-list.init.js') }}"></script>
