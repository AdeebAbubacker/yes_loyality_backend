                            ...
                            <td>
                                <div class="avatar-group">
                                    ...
                                    <a href="javascript: void(0);" class="avatar-group-item" data-img="avatar-10.jpg" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Username">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                    </a>
                                    ...
                                    <a href="javascript: void(0);" class="avatar-group-item" data-img="avatar-9.jpg" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Username">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-9.jpg')}}" alt="" class="rounded-circle avatar-xxs">
                                    </a>
                                </div>
                            </td>
                            <td>28 Feb, 2022</td>
                ...
                <table id="alternative-pagination" class="table nowrap dt-responsive align-middle table-hover table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/ant.svg')}}" alt="" class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/sol.svg')}}" alt="" class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/fil.svg')}}" alt="" class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/ada.svg')}}" alt="" class="avatar-xxs me-2">
...
<script src="{{ URL::asset('2_AdminPanel/js/pages/datatables.init.js') }}"></script>
