                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item carousel-item-next carousel-item-start">
                                    <img class="d-block img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt="Second slide">
                                </div>
                                <div class="carousel-item active carousel-item-start">
                                    <img class="d-block img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="Third slide">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img class="d-block img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" alt="Third slide">
                                </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt="Second slide">
                                </div>
                                <div class="carousel-item active">
                                    <img class="d-block img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" alt="Third slide">
                                </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" alt="" class="d-block img-fluid mx-auto">
                                ...
                                <div class="carousel-item active">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt="" class="d-block img-fluid mx-auto">
                                    <div class="carousel-caption text-white-50">
                                ...
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-9.jpg') }}" alt="" class="d-block img-fluid mx-auto">
                                    <div class="carousel-caption text-white-50">
                        ...
                        <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active" data-bs-interval="10000">
                                    <img src="{{URL::asset('2_AdminPanel//images/small/img-12.jpg')}}" class="d-block w-100" alt="First slide" />
                                </div>
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-11.jpg') }}" class="d-block w-100" alt="two slide" />
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-10.jpg') }}" class="d-block w-100" alt="There slide" />
                                </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-9.jpg') }}" class="d-block w-100" alt="One Slide" />
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-8.jpg') }}" class="d-block w-100" alt="Two Slide" />
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" class="d-block w-100" alt="Three Slide" />
                                </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active" data-bs-interval="10000">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" class="d-block w-100" alt="One Slide">
                                ...
                                <div class="carousel-item" data-bs-interval="2000">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" class="d-block w-100" alt="Two Slide">
                                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" class="d-block w-100" alt="Three Slide">
                                    <div class="carousel-caption d-none d-md-block">
