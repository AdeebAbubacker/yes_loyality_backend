...
<div class="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3 ms-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-xs" alt="">
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="userProfileCanvasExample">
        ...
        <div class="offcanvas-body profile-offcanvas p-0">
            ...
            <div class="p-3 text-center">
                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto">
                <div class="mt-3">
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="userProfileCanvasExample">
        ...
        <div class="offcanvas-body profile-offcanvas p-0">
            ...
            <div class="p-3 text-center">
                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-2.jpg')}}" alt="" class="avatar-lg img-thumbnail rounded-circle mx-auto profile-img">
                <div class="mt-3">
                    <h5 class="fs-16 mb-1"><a href="javascript:void(0);" class="link-primary username">Lisa Parker</a></h5>
                    <p class="text-muted"><i class="ri-checkbox-blank-circle-fill me-1 align-bottom text-success"></i>Online</p>
                </div>
    ...
    <!-- fgEmojiPicker js -->
    <script src="{{ URL::asset('2_AdminPanel/libs/fg-emoji-picker/fgEmojiPicker.js') }}"></script>

    <!-- chat init js -->
    <script src="{{ URL::asset('2_AdminPanel/js/pages/chat.init.js') }}"></script>
