...
<!-- jsvectormap css -->
<link href="{{ URL::asset('2_AdminPanel/libs/jsvectormap/css/jsvectormap.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
            ...
            <div class="col-xl-6">
                <div class="card overflow-hidden">
                    <div class="card-body bg-marketplace d-flex">
                        ...
                        <img src="{{URL::asset('2_AdminPanel/images/bg-d.png')}}" alt="" class="img-fluid" />
                    </div>
                </div>
            </div>
            <!--end col-->
                    ...
                    <div data-simplebar style="max-height: 365px;">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-01.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-8.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="avatar-xs object-cover rounded-circle">
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                                            <h6 class="fs-14 mb-1">Timothy Smith</h6>
                                        </a>
        ...
        <div class="swiper marketplace-swiper rounded gallery-light">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="card explore-box card-animate rounded">
                        <div class="explore-place-bid-img">
                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="img-fluid card-img-top explore-img" />
                            <div class="bg-overlay"></div>
                            <div class="place-bid-btn">
                                <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                            </div>
                        ...
                        <table class="table table-borderless align-middle">
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-01.jpg')}}" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-02.jpg')}}" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="avatar-sm rounded-circle">
                                            <div class="ms-3">
                                                <a href="#!">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-01.jpg')}}" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <td><img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/btc.svg')}}" class="avatar-xxs me-2" alt="">48,568.025</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/ltc.svg')}}" class="avatar-xxs me-2" alt="">87,142.027</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <td><img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/etc.svg')}}" class="avatar-xxs me-2" alt="">33,847.961</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <td><img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/dash.svg')}}" class="avatar-xxs me-2" alt="">73,654.421</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <td><img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/bnb.svg')}}" class="avatar-xxs me-2" alt="">66,742.077</td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2">
                                            <img src="{{URL::asset('2_AdminPanel/images/nft/img-02.jpg')}}" alt="" class="avatar-xs rounded-circle">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <td><img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/usdt.svg')}}" class="avatar-xxs me-2" alt="">34,736.209</td>
                                <td>
    ...
    <div class="col-xxl-3 col-lg-6">
        <div class="card card-height-100">
            ...
            <div class="card-body">
                ...
                <div class="mt-1">
                    <p class="mb-1"><img src="{{URL::asset('2_AdminPanel/images/flags/us.svg')}}" alt="" height="15" class="rounded me-2"> United States <span class="float-end">34%</span></p>
                    <p class="mb-1"><img src="{{URL::asset('2_AdminPanel/images/flags/russia.svg')}}" alt="" height="15" class="rounded me-2"> Russia <span class="float-end">27%</span></p>
                    <p class="mb-1"><img src="{{URL::asset('2_AdminPanel/images/flags/spain.svg')}}" alt="" height="15" class="rounded me-2"> Spain <span class="float-end">21%</span></p>
                    <p class="mb-1"><img src="{{URL::asset('2_AdminPanel/images/flags/italy.svg')}}" alt="" height="15" class="rounded me-2"> Italy <span class="float-end">13%</span></p>
                    <p class="mb-0"><img src="{{URL::asset('2_AdminPanel/images/flags/germany.svg')}}" alt="" height="15" class="rounded me-2"> Germany <span class="float-end">5%</span></p>
                </div>
            </div>
            <!-- end card body -->
        </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" height="220" class="object-cover w-100" />
                        ...
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" height="220" class="object-cover w-100" />
                                <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <a href="#!">
                        ...
                        <div class="swiper-slide">
                            <div class="dash-collection overflow-hidden rounded-top position-relative">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" height="220" class="object-cover w-100" />
                                <div class="content position-absolute bottom-0 m-2 p-2 start-0 end-0 rounded d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <a href="#!">
                ...
                <div class="swiper collection-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-02.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-01.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                                    <a href="pages-profile">
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                                    <a href="pages-profile">
                        ...
                        <div class="swiper-slide">
                            <div class="d-flex">
                                <div class="flex-shink-0">
                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-1.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                </div>
                                <div class="ms-3 flex-grow-1">
                                    <a href="pages-profile">
...
<!-- Vector map-->
<script src="{{ URL::asset('2_AdminPanel/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/libs/jsvectormap/maps/world-merc.js') }}"></script>

<!-- Countdown js -->
<script src="{{ URL::asset('2_AdminPanel/js/pages/coming-soon.init.js') }}"></script>

<!-- Marketplace init -->
<script src="{{ URL::asset('2_AdminPanel/js/pages/dashboard-nft.init.js') }}"></script>
