        ...
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="explore-place-bid-img overflow-hidden rounded">
                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="img-fluid explore-img">
    ...
    <div class="col">
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="explore-place-bid-img overflow-hidden rounded">
                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="img-fluid explore-img">
                    <div class="bg-overlay"></div>
                    <div class="place-bid-btn">
                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                    </div>
    ...
    <div class="col">
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="explore-place-bid-img overflow-hidden rounded">
                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="img-fluid explore-img">
                    <div class="bg-overlay"></div>
                    <div class="place-bid-btn">
                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                    </div>
...
<div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="explore-place-bid-img">
                <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" class="card-img-top explore-img" />
                <div class="bg-overlay"></div>
                <div class="place-bid-btn">
                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                </div>
...
<div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
    <div class="col">
        <div class="card">
            <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="card-img-top object-cover" height="120">
            <div class="card-body text-center">
                <img src="{{URL::asset('2_AdminPanel/images/users/avatar-1.jpg')}}" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
    ...
    <div class="col">
        <div class="card">
            <img src="{{URL::asset('2_AdminPanel/images/nft/img-01.jpg')}}" alt="" class="card-img-top object-cover" height="120">
            <div class="card-body text-center">
                <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
    ...
    <div class="col">
        <div class="card">
            <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="card-img-top object-cover" height="120">
            <div class="card-body text-center">
    ...
    <div class="col">
        <div class="card">
            <img src="{{URL::asset('2_AdminPanel/images/nft/img-02.jpg')}}" alt="" class="card-img-top object-cover" height="120">
            <div class="card-body text-center">
