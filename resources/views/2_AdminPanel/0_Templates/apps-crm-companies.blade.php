                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('2_AdminPanel/images/brands/dribbble.png') }}" alt="" class="avatar-xxs rounded-circle image_src object-cover">
                                            </div>
                                                ...
                                                <div class="position-relative d-inline-block">
                                                    ...
                                                    <div class="avatar-lg p-1">
                                                        <div class="avatar-title bg-light rounded-circle">
                                                            <img src="{{ URL::asset('2_AdminPanel/images/users/multi-user.jpg') }}" alt="" id="companylogo-img" class="avatar-md rounded-circle object-cover">
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="card" id="company-view-detail">
            <div class="card-body text-center">
                <div class="position-relative d-inline-block">
                    <div class="avatar-md">
                        <div class="avatar-title bg-light rounded-circle">
                            <img src="{{ URL::asset('2_AdminPanel/images/brands/mail_chimp.png') }}" alt="" class="avatar-sm rounded-circle object-cover">
                        </div>
                    </div>
                </div>
...
<script src="{{ URL::asset('2_AdminPanel/js/pages/crm-companies.init.js') }}"></script>
