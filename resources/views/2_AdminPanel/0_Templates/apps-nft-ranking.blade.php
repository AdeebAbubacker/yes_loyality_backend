                    ...
                    <table class="table align-middle table-nowrap table-hover" id="customerTable">
                        ...
                        <tbody class="list form-check-all">
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-01.jpg')}}" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Abstract Face Painting</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-02.jpg')}}" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Creative Filtered Portrait</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Robotic Body Art</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Smillevers Crypto</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">The Chirstoper</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Walking On Air</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" class="avatar-xs rounded-circle object-cover me-2"> <a href="apps-nft-item-details" class="link-dark">Highstreet IHO Part</a>
                                    </div>
                                </td>
...
<script src="{{ URL::asset('2_AdminPanel/js/pages/apps-nft-ranking.init.js') }}"></script>
