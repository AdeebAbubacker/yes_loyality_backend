...
@section('css')
    <link href="{{ URL::asset('2_AdminPanel/libs/aos/aos.css') }}" rel="stylesheet">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-sm-10 col-lg-8">
                                                <div data-aos="fade-up">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/mac-img.png') }}" alt="Mac Image"
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
...
@endsection
@section('script')
    <script src="{{ URL::asset('2_AdminPanel/libs/aos/aos.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/libs/prismjs/prism.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/js/pages/animation-aos.init.js') }}"></script>
