...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="position-relative home-img text-center mt-5 mt-lg-0">
                            ...
                            <div class="card p-3 rounded shadow-lg application-box">
                                ...
                                <div class="avatar-group">
                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                        <div class="avatar-xs">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-3.jpg')}}" alt="" class="rounded-circle img-fluid">
                                        </div>
                                    </a>
                                    ...
                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Ellen Smith">
                                        <div class="avatar-xs">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jpg')}}" alt="" class="rounded-circle img-fluid">
                                        </div>
                                    </a>
                                    ...
                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                        <div class="avatar-xs">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-9.jpg')}}" alt="" class="rounded-circle img-fluid">
                                        </div>
                                    </a>
                            ...
                            <img src="{{URL::asset('2_AdminPanel/images/job-profile2.png')}}" alt="" class="user-img">
                ...
                <div class="row align-items-center justify-content-lg-between justify-content-center gy-4">
                    <div class="col-lg-5 col-sm-7">
                        <div class="about-img-section mb-5 mb-lg-0 text-center">
                            ...
                            <div class="card feedback-box">
                                <div class="card-body d-flex shadow-lg">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jpg')}}" alt="" class="avatar-sm rounded-circle">
                                    </div>
                            ...
                            <img src="{{URL::asset('2_AdminPanel/images/about.jpg')}}" alt="" class="img-fluid mx-auto rounded-3" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                                ...
                                <div class="d-flex">
                                    <div class="avatar-sm">
                                        <div class="avatar-title bg-soft-warning rounded">
                                            <img src="{{URL::asset('2_AdminPanel/images/companies/img-3.png')}}" alt="" class="avatar-xxs">
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex">
                                    <div class="avatar-sm">
                                        <div class="avatar-title bg-soft-primary rounded">
                                            <img src="{{URL::asset('2_AdminPanel/images/companies/img-2.png')}}" alt="" class="avatar-xxs">
                                        </div>
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                                ...
                                <div class="d-flex">
                                    <div class="avatar-sm">
                                        <div class="avatar-title bg-soft-danger rounded">
                                            <img src="{{URL::asset('2_AdminPanel/images/companies/img-4.png')}}" alt="" class="avatar-xxs">
                                        </div>
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                                ...
                                <div class="d-flex">
                                    <div class="avatar-sm">
                                        <div class="avatar-title bg-soft-success rounded">
                                            <img src="{{URL::asset('2_AdminPanel/images/companies/img-9.png')}}" alt="" class="avatar-xxs">
                                        </div>
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                                ...
                                <div class="d-flex">
                                    <div class="avatar-sm">
                                        <div class="avatar-title bg-soft-info rounded">
                                            <img src="{{URL::asset('2_AdminPanel/images/companies/img-1.png')}}" alt="" class="avatar-xxs">
                                        </div>
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="avatar-sm">
                                        <div class="avatar-title bg-soft-success rounded">
                                            <img src="{{URL::asset('2_AdminPanel/images/companies/img-7.png')}}" alt="" class="avatar-xxs">
                                        </div>
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="avatar-sm">
                                        <div class="avatar-title bg-soft-info rounded">
                                            <img src="{{URL::asset('2_AdminPanel/images/companies/img-8.png')}}" alt="" class="avatar-xxs">
                                        </div>
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="avatar-sm">
                                        <div class="avatar-title bg-soft-warning rounded">
                                            <img src="{{URL::asset('2_AdminPanel/images/companies/img-5.png')}}" alt="" class="avatar-xxs">
                                        </div>
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="#!">
                                        ...
                                        <a href="javascript: void(0);" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                            <div class="avatar-xs">
                                                <div class="avatar-title bg-light bg-opacity-25 rounded-circle">
                                                    <img src="{{URL::asset('2_AdminPanel/images/companies/img-5.png')}}" alt="" height="15">
                                                </div>
                                            </div>
                                        </a>
                                        <a href="javascript: void(0);" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                            <div class="avatar-xs">
                                                <div class="avatar-title bg-light bg-opacity-25 rounded-circle">
                                                    <img src="{{URL::asset('2_AdminPanel/images/companies/img-2.png')}}" alt="" height="15">
                                                </div>
                                            </div>
                                        </a>
                                        <a href="javascript: void(0);" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                            <div class="avatar-xs">
                                                <div class="avatar-title bg-light bg-opacity-25 rounded-circle">
                                                    <img src="{{URL::asset('2_AdminPanel/images/companies/img-8.png')}}" alt="" height="15">
                                                </div>
                                            </div>
                                        </a>
                                        <a href="javascript: void(0);" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Brent Gonzalez">
                                            <div class="avatar-xs">
                                                <div class="avatar-title bg-light bg-opacity-25 rounded-circle">
                                                    <img src="{{URL::asset('2_AdminPanel/images/companies/img-7.png')}}" alt="" height="15">
                                                </div>
                                            </div>
                                        </a>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-2.jpg')}}" alt="" class="rounded-circle avatar-md mx-auto d-block">
                                ...
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-3.jpg')}}" alt="" class="rounded-circle avatar-md mx-auto d-block">
                                ...
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jpg')}}" alt="" class="rounded-circle avatar-md mx-auto d-block">
                                ...
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-8.jpg')}}" alt="" class="rounded-circle avatar-md mx-auto d-block" />
                                ...
                                <div class="swiper-slide">
                                    <div class="card text-center">
                                        <div class="card-body p-4">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/avatar-5.jpg')}}" alt="" class="rounded-circle avatar-md mx-auto d-block" />
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{URL::asset('2_AdminPanel/images/small/img-8.jpg')}}" alt="" class="img-fluid rounded" />
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{URL::asset('2_AdminPanel/images/small/img-6.jpg')}}" alt="" class="img-fluid rounded" />
                            </div>
                            <div class="card-body">
                                <ul class="list-inline fs-14 text-muted">
                                    <li class="list-inline-item">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{URL::asset('2_AdminPanel/images/small/img-9.jpg')}}" alt="" class="img-fluid rounded" />
                            </div>
                            <div class="card-body">
                                <ul class="list-inline fs-14 text-muted">
                                    <li class="list-inline-item">
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/job-lading.init.js') }}"></script>
    @endsection
