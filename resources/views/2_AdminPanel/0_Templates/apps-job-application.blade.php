                                ...
                                <tr>
                                    ...
                                    <td class="company">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{URL::asset('2_AdminPanel/images/brands/slack.png')}}" alt="" class="avatar-xxs rounded-circle image_src object-cover">
                                            </div>
                                        ...
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <div class="avatar-lg p-1">
                                                <div class="avatar-title bg-light rounded-circle">
                                                    <img src="{{URL::asset('2_AdminPanel/images/users/multi-user.jpg')}}" id="companylogo-img" class="avatar-md h-auto rounded-circle object-cover" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="{{URL::asset('2_AdminPanel/js/pages/job-application.init.js')}}"></script>
