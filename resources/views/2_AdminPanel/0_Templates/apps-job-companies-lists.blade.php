            ...
            <div class="card-body">
                <div class="avatar-lg mx-auto mb-3">
                    <div class="avatar-title bg-light rounded">
                        <img src="{{URL::asset('2_AdminPanel/images/companies/img-6.png')}}" alt="" class="avatar-sm company-logo">
                    </div>
                </div>
...
<script src="{{URL::asset('2_AdminPanel/js/pages/job-companies-lists.init.js')}}"></script>
