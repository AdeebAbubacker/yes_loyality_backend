...
<div class="row">
    ...
    <div class="col-xxl-3">
        <div class="card job-list-view-card overflow-hidden" id="job-overview">
            <img src="{{URL::asset('2_AdminPanel/images/small/img-10.jpg')}}" alt="" id="cover-img" class="img-fluid background object-cover">
            <div class="card-body">
                <div class="avatar-md mt-n5">
                    <div class="avatar-title bg-light rounded-circle">
                        <img src="{{URL::asset('2_AdminPanel/images/companies/img-7.png')}}" alt="" class="avatar-xs view-companylogo">
                    </div>
                </div>
                <div class="mt-3">
                        ...
                        <div class="col-lg-12">
                            <div class="px-1 pt-1">
                                <div class="modal-team-cover position-relative mb-0 mt-n4 mx-n4 rounded-top overflow-hidden">
                                    <img src="{{URL::asset('2_AdminPanel/images/small/img-9.jpg')}}" alt="" id="modal-cover-img" class="img-fluid">
                            ...
                            <div class="text-center mb-4 mt-n5 pt-2">
                                <div class="position-relative d-inline-block">
                                    ...
                                    <div class="avatar-lg p-1">
                                        <div class="avatar-title bg-light rounded-circle">
                                            <img src="{{URL::asset('2_AdminPanel/images/users/multi-user.jpg')}}" id="companylogo-img" class="avatar-md rounded-circle object-cover" />
                                        </div>
                                    </div>
                                </div>
...
<script src="{{URL::asset('2_AdminPanel/js/pages/job-list.init.js')}}"></script>
