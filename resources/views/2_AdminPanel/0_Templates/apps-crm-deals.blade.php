...
@endsection
@section('css')
<link href="{{ URL::asset('2_AdminPanel/libs/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated1"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-5.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated2"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/brands/github.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated4"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated5"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/brands/mail_chimp.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified3"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/brands/dribbble.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified6"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-6.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged1"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-5.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged3"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-8.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted2" role="button"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/brands/slack.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted5" role="button"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-3.png') }}" alt="" class="avatar-xs rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-3">
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/crm-deals.init.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/libs/sweetalert2/sweetalert2.min.js') }}"></script>
