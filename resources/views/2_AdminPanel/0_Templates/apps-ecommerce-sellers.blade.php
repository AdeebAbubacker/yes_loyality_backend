...
<div class="row mt-4">
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                ...
                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-1.png') }}" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-2.png') }}" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-3.png') }}" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                <div class="ribbon ribbon-info ribbon-shape trending-ribbon"><i class="ri-flashlight-fill text-white align-bottom"></i> <span class="trending-ribbon-text">Trending</span></div>
                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-4.png') }}" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-5.png') }}" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                <div class="ribbon ribbon-info ribbon-shape trending-ribbon"><i class="ri-flashlight-fill text-white align-bottom"></i> <span class="trending-ribbon-text">Trending</span></div>
                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-6.png') }}" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card ribbon-box right overflow-hidden">
            <div class="card-body text-center p-4">
                <div class="ribbon ribbon-info ribbon-shape trending-ribbon"><i class="ri-flashlight-fill text-white align-bottom"></i> <span class="trending-ribbon-text">Trending</span></div>
                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-7.png') }}" alt="" height="45">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card">
            <div class="card-body text-center p-4">
                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-8.png') }}" alt="" height="45">
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/sellers.init.js') }}"></script>
