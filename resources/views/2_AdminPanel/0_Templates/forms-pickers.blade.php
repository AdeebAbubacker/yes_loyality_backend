...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ URL::asset('2_AdminPanel/libs/@simonwep/pickr/themes/classic.min.css') }}" /> <!-- 'classic' theme -->
    <link rel="stylesheet" href="{{ URL::asset('2_AdminPanel/libs/@simonwep/pickr/themes/monolith.min.css') }}" /> <!-- 'monolith' theme -->
    <link rel="stylesheet" href="{{ URL::asset('2_AdminPanel/libs/@simonwep/pickr/themes/nano.min.css') }}" /> <!-- 'nano' theme -->
@endsection
@section('content')
...
@endsection
@section('script')
    <script src="{{ URL::asset('2_AdminPanel/libs/@simonwep/pickr/pickr.min.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/js/pages/form-pickers.init.js') }}"></script>
