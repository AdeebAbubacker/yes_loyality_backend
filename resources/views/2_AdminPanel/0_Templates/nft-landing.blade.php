...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
        ...
        <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
            <div class="container">
                <a class="navbar-brand" href="index">
                    <img src="{{URL::asset('2_AdminPanel/images/logo-dark.png')}}" class="card-logo card-logo-dark" alt="logo dark" height="17">
                    <img src="{{URL::asset('2_AdminPanel/images/logo-light.png')}}" class="card-logo card-logo-light" alt="logo light" height="17">
                </a>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/wallet/metamask.png')}}" alt="" height="55" class="mb-3 pb-2">
                                <h5>Metamask</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/wallet/coinbase.png')}}" alt="" height="55" class="mb-3 pb-2">
                    ...
                    <div class="col-lg-4">
                        <div class="card text-center border shadow-none">
                            <div class="card-body py-5 px-4">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/wallet/binance.png')}}" alt="" height="55" class="mb-3 pb-2">
                                <h5>Binance</h5>
                ...
                <div class="row">
                    <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                    ...
                    <div class="col-lg-4 product-item music crypto-card games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/img-02.jpg')}}" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                    ...
                    <div class="col-lg-4 product-item crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/img-01.jpg')}}" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                    ...
                    <div class="col-lg-4 product-item games music 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                    ...
                    <div class="col-lg-4 product-item artwork music crypto-card">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="explore-place-bid-img">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="card-img-top explore-img" />
                                <div class="bg-overlay"></div>
                                <div class="place-bid-btn">
                                    <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/wallet.png')}}" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/money.png')}}" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/add.png')}}" alt="" class="avatar-sm">
                    ...
                    <div class="col-lg-3">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <img src="{{URL::asset('2_AdminPanel/images/nft/sell.png')}}" alt="" class="avatar-sm">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="img-fluid rounded">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="img-fluid rounded">
                                                </div>
                                                <!--end col-->
                                            </div>
                                            <!--end row-->
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="img-fluid rounded">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-04.jpg')}}" alt="" class="img-fluid rounded">
                                                </div>
                                                <!--end col-->
                                            </div>
                                            <!--end row-->
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-6">
                                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-02.jpg')}}" alt="" class="img-fluid rounded">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-01.jpg')}}" alt="" class="img-fluid rounded">
                                                </div>
                                                <!--end col-->
                                            </div>
                                            <!--end row-->
                ...
                <div class="row">
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-2.jpg')}}" alt="" class="avatar-xs rounded-circle">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-05.jpg')}}" alt="" class="explore-img w-100">
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-9.jpg')}}" alt="" class="avatar-xs rounded-circle">
                                    <div class="ms-2 flex-grow-1">
                                        <a href="#!">
                                ...
                                <div class="explore-place-bid-img overflow-hidden rounded">
                                    <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="explore-img w-100">
                                    <div class="bg-overlay"></div>
                                    <div class="place-bid-btn">
                                        <a href="#!" class="btn btn-success"><i class="ri-auction-fill align-bottom me-1"></i> Place Bid</a>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-10.jpg')}}" alt="" class="avatar-xs rounded-circle">
                                    <div class="ms-2 flex-grow-1">
                                        <a href="#!">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shink-0">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-5.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="pages-profile">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shink-0">
                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="pages-profile">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-shink-0">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-8.jpg')}}" alt="" class="avatar-sm object-cover rounded">
                                    </div>
                                    <div class="ms-3 flex-grow-1">
                                        <a href="pages-profile">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 mt-4">
                        <div>
                            <div>
                                <img src="{{URL::asset('2_AdminPanel/images/logo-light.png')}}" alt="logo light" height="17">
                            </div>
                            <div class="mt-4">
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/nft-landing.init.js') }}"></script>
    @endsection
