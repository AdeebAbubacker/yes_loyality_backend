...
@endsection
@section('css')
    <link href="{{ URL::asset('2_AdminPanel/libs/nouislider/nouislider.min.css') }}" rel="stylesheet">
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/ecommerce-product-list.init.js') }}"></script>
