                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-warning rounded p-2">
                                        <img src="{{ URL::asset('2_AdminPanel/images/brands/slack.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-danger rounded p-2">
                                        <img src="{{ URL::asset('2_AdminPanel/images/brands/dribbble.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-success rounded p-2">
                                        <img src="{{ URL::asset('2_AdminPanel/images/brands/mail_chimp.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                            ...
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-soft-info rounded p-2">
                                        <img src="{{ URL::asset('2_AdminPanel/images/brands/dropbox.png') }}" alt="" class="img-fluid p-1">
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1">
                ...
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-secondary rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('2_AdminPanel/images/brands/dribbble.png') }}" alt="" height="32">
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-light rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('2_AdminPanel/images/brands/slack.png') }}" alt="" height="32">
                        </div>
                    </div>
                    <div class="py-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-primary rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('2_AdminPanel/images/brands/dropbox.png') }}" alt="" height="32">
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-danger rounded-top">
                        ...
                        <div class="text-center pb-3">
                            <img src="{{ URL::asset('2_AdminPanel/images/brands/mail_chimp.png') }}" alt="" height="32">
                        </div>
                    </div>
...
@endsection
@section('script')
    <script src="{{ URL::asset('2_AdminPanel/js/pages/project-list.init.js') }}"></script>
