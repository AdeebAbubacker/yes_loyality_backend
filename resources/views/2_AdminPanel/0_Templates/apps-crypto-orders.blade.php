                        ...
                        <tbody class="list form-check-all">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/eth.svg')}}" alt="" class="avatar-xxs" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/mkr.svg')}}" alt="" class="avatar-xxs" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/yfi.svg')}}" alt="" class="avatar-xxs" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/dash.svg')}}" alt="" class="avatar-xxs" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/neo.svg')}}" alt="" class="avatar-xxs" />
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="{{URL::asset('2_AdminPanel/images/svg/crypto-icons/mln.svg')}}" alt="" class="avatar-xxs" />
                                        </div>
...
<script src="{{ URL::asset('2_AdminPanel/js/pages/crypto-orders.init.js') }}"></script>
