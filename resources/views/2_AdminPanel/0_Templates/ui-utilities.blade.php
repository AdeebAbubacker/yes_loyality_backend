                ...
                <div class="live-preview">
                    <div>
                        <div>
                            <div class="d-flex align-items-start flex-wrap gap-4">
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" class="avatar-md rounded" alt="rounded">
                                    <p><code>.rounded</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" class="avatar-md rounded-top" alt="rounded-top">
                                    <p><code>.rounded-top</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" class="avatar-md rounded-end" alt="rounded-end">
                                    <p><code>.rounded-end</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" class="avatar-md rounded-bottom" alt="rounded-bottom">
                                    <p><code>.rounded-bottom</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" class="avatar-md rounded-start" alt="rounded-start">
                                    <p><code>.rounded-start</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" class="avatar-md rounded-circle" alt="rounded-circle">
                                ...
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" class="avatar-md w-auto rounded-pill" alt="rounded-pill">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-start flex-wrap gap-4">
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" class="avatar-md rounded-0" alt="rounded-0">
                                    <p><code>.rounded-0</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" class="avatar-md rounded-1" alt="rounded-1">
                                    <p><code>.rounded-1</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" class="avatar-md rounded-2" alt="rounded-2">
                                    <p><code>.rounded-2</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" class="avatar-md rounded-3" alt="rounded-3">
                                    <p><code>.rounded-3</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-1.jpg')}}" class="avatar-md rounded-4" alt="rounded-4">
                                    <p><code>.rounded-4</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="{{URL::asset('2_AdminPanel/images/users/avatar-1.jpg')}}" class="avatar-md rounded-5" alt="rounded-5">
