                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/products/img-1.png') }}" alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/products/img-3.png') }}" alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/products/img-4.png') }}" alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm bg-light rounded p-1 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/products/img-5.png') }}" alt="" class="img-fluid d-block" />
                                                    </div>
                                                    <div>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/companies/img-1.png') }}" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/companies/img-2.png') }}" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/companies/img-3.png') }}" alt="" class="avatar-sm p-2" />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/companies/img-8.png') }}" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/companies/img-5.png') }}" alt="" class="avatar-sm p-2" />
                                                    </div>
                                                    <div class="flex-grow-1">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                    </div>
            ...
            <div class="card h-100 rounded-0">
                <div class="card-body p-0">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-sm">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/companies/img-1.png') }}" alt="" height="30">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card border border-dashed shadow-none">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" alt="" class="avatar-sm rounded">
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <div>
                                                        <p class="text-muted mb-1 fst-italic text-truncate-two-lines">
                                    ...
                                    <div class="card border border-dashed shadow-none">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-sm">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/companies/img-8.png') }}" alt="" height="30">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card border border-dashed shadow-none">
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" alt="" class="avatar-sm rounded">
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <div>
                                                        <p class="text-muted mb-1 fst-italic text-truncate-two-lines">
                    ...
                    <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                        <div class="card-body">
                            <img src="{{ URL::asset('2_AdminPanel/images/giftbox.png') }}" alt="">
                            <div class="mt-4">
...
<!-- dashboard init -->
<script src="{{ URL::asset('2_AdminPanel/js/pages/dashboard-ecommerce.init.js') }}"></script>
