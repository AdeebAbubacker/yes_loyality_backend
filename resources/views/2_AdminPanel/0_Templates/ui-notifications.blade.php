                            ...
                            <div class="col-xxl-6">
                                ...
                                <div class="toast fade show" role="alert" aria-live="assertive"
                                    ...
                                    <div class="toast-header">
                                        <img src="{{ URL::asset('2_AdminPanel/images/logo-sm.png') }}" class="rounded me-2"
                                            alt="..." height="20">
                                    ...
                                    <div>
                                        ...
                                        <div class="bg-light" aria-live="polite" aria-atomic="true"
                                            ...
                                            <div class="toast fade show" role="alert" aria-live="assertive"
                                                ...
                                                <div class="toast-header">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/logo-sm.png') }}"
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/notifications.init.js') }}"></script>
