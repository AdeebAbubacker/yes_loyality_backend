...
@section('css')
<link href="{{ URL::asset('2_AdminPanel/libs/gridjs/theme/mermaid.min.css') }}" rel="stylesheet">
                ...
                <div>
                    <div class="flex-shrink-0 avatar-md mx-auto">
                        <div class="avatar-title bg-light rounded">
                            <img src="{{ URL::asset('2_AdminPanel/images/companies/img-2.png') }}" alt="" height="50" />
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-1.png') }}" alt=""
                                                    height="30">
                                            </div>
                                        </div>
                            ...
                            <div class="card border border-dashed shadow-none">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 avatar-sm">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-8.png') }}" alt=""
                                                    height="30">
                                            </div>
                                        </div>
                                        <div class="flex-grow-1 ms-3">
...
@endsection
@section('script')
<script src="{{ URL::asset('2_AdminPanel/libs/nouislider/nouislider.min.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/libs/wnumb/wNumb.min.js') }}"></script>
...
<script src="{{ URL::asset('2_AdminPanel/js/pages/seller-details.init.js') }}"></script>
