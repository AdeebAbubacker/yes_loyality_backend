                        ...
                        <ul class="list list-group list-group-flush mb-0">
                            <li class="list-group-item" data-id="1">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div>
                                            <img class="image avatar-xs rounded-circle" alt="" src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item" data-id="2">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div>
                                            <img class="image avatar-xs rounded-circle" alt="" src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item" data-id="3">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div>
                                            <img class="image avatar-xs rounded-circle" alt="" src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item" data-id="4">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div>
                                            <img class="image avatar-xs rounded-circle" alt="" src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}">
                                        </div>
                                    </div>
                                </div>
                            </li>
...
<!-- listjs init -->
<script src="{{ URL::asset('2_AdminPanel/js/pages/listjs.init.js') }}"></script>
