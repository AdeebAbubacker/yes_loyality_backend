...
@section('css')
<link href="{{ URL::asset('2_AdminPanel/libs/multi.js/multi.min.css') }}" rel="stylesheet">
<link href="{{ URL::asset('2_AdminPanel/libs/@tarekraafat/autocomplete.js/css/autoComplete.css') }}" rel="stylesheet">
@endsection
@section('content')
<div class="row">
    <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <div class="input-group" data-input-flag>
                                <button class="btn btn-light border" type="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="{{URL::asset('2_AdminPanel/images/flags/us.svg')}}" alt="flag img" height="20" class="country-flagimg rounded"><span class="ms-2 country-codeno">+ 1</span></button>
...
@endsection
@section('script')
<script src="{{ URL::asset('2_AdminPanel/libs/multi.js/multi.min.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/libs/@tarekraafat/autocomplete.js/autoComplete.min.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/js/pages/form-advanced.init.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/js/pages/form-input-spin.init.js') }}"></script>
<!-- input flag init -->
<script src="{{URL::asset('2_AdminPanel/js/pages/flag-input.init.js')}}"></script>
