        ...
        <div class="card product">
            <div class="card-body">
                <div class="row gy-3">
                    <div class="col-sm-auto">
                        <div class="avatar-lg bg-light rounded p-1">
                            <img src="{{ URL::asset('2_AdminPanel/images/products/img-7.png') }}" alt=""
                                class="img-fluid d-block">
                        </div>
                    </div>
                    <div class="col-sm">
        ...
        <div class="card product">
            <div class="card-body">
                <div class="row gy-3">
                    <div class="col-sm-auto">
                        <div class="avatar-lg bg-light rounded p-1">
                            <img src="{{ URL::asset('2_AdminPanel/images/products/img-3.png') }}" alt=""
                                class="img-fluid d-block">
                        </div>
                    </div>
                    <div class="col-sm">
...
<script src="{{ URL::asset('2_AdminPanel/js/pages/ecommerce-cart.init.js') }}"></script>
