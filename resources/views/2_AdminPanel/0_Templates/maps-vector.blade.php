...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/libs/jsvectormap/maps/canada.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/libs/jsvectormap/maps/russia.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/libs/jsvectormap/maps/spain.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/js/pages/vector-maps.init.js') }}"></script>
