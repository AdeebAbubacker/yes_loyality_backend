...
@section('content')
    <div class="position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg profile-setting-img">
            <img src="{{ URL::asset('2_AdminPanel/images/profile-bg.jpg') }}" class="profile-wid-img" alt="">
...
@endsection
@section('script')
    <script src="{{ URL::asset('2_AdminPanel/js/pages/profile-setting.init.js') }}"></script>
