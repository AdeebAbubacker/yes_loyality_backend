            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/companies/img-6.png') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/vtc.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/xsg.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/bela.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/arn.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/cs.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/add.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/atm.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2 ribbon-box ribbon-fill right">
                ...
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/bcbc.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2 ribbon-box ribbon-fill right">
                ...
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/bix.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2 ribbon-box ribbon-fill right">
                ...
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/rise.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card ribbon-box ribbon-fill right">
                ...
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/ark.svg') }}" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
