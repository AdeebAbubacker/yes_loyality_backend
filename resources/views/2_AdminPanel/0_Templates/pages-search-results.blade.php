...
@section('css')
    <link href="{{ URL::asset('2_AdminPanel/libs/swiper/swiper-bundle.min.css') }}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="{{ URL::asset('2_AdminPanel/libs/glightbox/css/glightbox.min.css') }}">
                                    ...
                                    <div class="col-xl-4 col-lg-10">
                                        <div class="row g-2">
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" class="image-popup d-block">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" alt="" class="img-fluid d-block rounded" />
                                                    </a>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" class="image-popup d-block">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="" class="img-fluid d-block rounded" />
                                                    </a>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-3 col-sm-6">
                                                <div>
                                                    <a href="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" class="image-popup d-block">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" alt="" class="img-fluid d-block rounded" />
                                                    </a>
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-3 col-sm-6">
                                                <div class="search-more-results rounded">
                                                    <a href="javascript:void(0);" onclick="myFunction()" class="d-block">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" alt="" class="img-fluid d-block rounded" />
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-12.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-11.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-10.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-9.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-8.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="d-flex align-items-center border border-dashed rounded p-2">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="" width="65" class="rounded" />
                                                    </div>
                                                    <div class="flex-grow-1 ms-2">
                            ...
                            <div class="gallery-light">
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" alt="" />
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-8.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-8.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                                        <h5 class="overlay-caption">Glasses and laptop from above</h5>
                                                    </div>
                                                </a>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-9.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-9.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-10.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-10.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-11.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-11.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('2_AdminPanel/images/small/img-12.jpg') }}" title="">
                                                    <img class="gallery-img img-fluid mx-auto" src="{{ URL::asset('2_AdminPanel/images/small/img-12.jpg') }}" alt="" />
                                                    <div class="gallery-overlay">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span class="badge badge-soft-success fs-11">Business</span></li>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span class="badge badge-soft-danger fs-11">Design</span></li>
                                ...
                                <div class="col-lg-6">
                                    <div class="card border">
                                        <div class="card-body">
                                            <div class="d-sm-flex">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/small/img-8.jpg') }}" alt="" width="115" class="rounded-1" />
                                                </div>
                                                <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                    <ul class="list-inline mb-2">
                                                        <li class="list-inline-item"><span class="badge badge-soft-warning fs-11">Development</span></li>
...
@endsection
@section('script')
    <script src="{{ URL::asset('2_AdminPanel/libs/glightbox/js/glightbox.min.js') }}"></script>

    <!-- swiper js -->
    <script src="{{ URL::asset('2_AdminPanel/libs/swiper/swiper-bundle.min.js') }}"></script>

    <!-- search-result init js -->
    <script src="{{ URL::asset('2_AdminPanel/js/pages/search-result.init.js') }}"></script>
