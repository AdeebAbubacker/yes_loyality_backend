...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6 col-xl-3">
            <!-- Simple card -->
            <div class="card">
                <img class="card-img-top img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <img class="card-img-top img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <img class="card-img-top img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="Card image cap">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                ...
                <img class="img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" alt="Card image cap">
                <div class="card-body">
            ...
            <div class="row row-cols-xxl-5 row-cols-lg-3 row-cols-1">
                    ...
                    <div class="card card-body">
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" alt="" class="avatar-sm rounded-circle" />
                            </div>
                ...
                <div class="col">
                    <div class="card card-body">
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt="" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-2">
                ...
                <div class="col">
                    <div class="card card-body">
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" alt="" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-2">
                ...
                <div class="col">
                    <div class="card card-body">
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-5.jpg') }}" alt="" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-2">
                ...
                <div class="col">
                    <div class="card card-body">
                        <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-6.jpg') }}" alt="" class="avatar-sm rounded-circle" />
                            </div>
                            <div class="flex-grow-1 ms-2">
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body p-4 text-center">
                    <div class="mx-auto avatar-md mb-3">
                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-8.jpg') }}" alt="" class="img-fluid rounded-circle">
                    </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                ...
                <div class="card-body p-4 text-center">
                    <div class="mx-auto avatar-md mb-3">
                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-5.jpg') }}" alt="" class="img-fluid rounded-circle">
                    </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                ...
                <div class="card-body p-4 text-center">
                    <div class="mx-auto avatar-md mb-3">
                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" alt="" class="img-fluid rounded-circle">
                    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-12.jpg') }}" alt="Card image">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" alt="Card image">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-overlay">
                        <img class="card-img img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" alt="Card image">
            ...
            <div class="row">
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" alt="Card image cap">
                        <div class="card-body">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" alt="Card image cap">
                    </div>
                </div><!-- end col -->
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-8.jpg') }}" alt="Card image cap">
                        <div class="card-footer">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-10.jpg') }}" alt="Card image cap">
                        <div class="card-footer">
                            <p class="card-text mb-0">
                                Last updated 3 mins ago
                            </p>
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        <img class="card-img-top img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-11.jpg') }}" alt="Card image cap">
                        <div class="card-header">
                            <h4 class="card-title mb-0">A day in the of a professional fashion designer</h4>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card">
                        ...
                        <img class="card-img-bottom img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-11.jpg') }}" alt="Card image cap">
                    </div>
                </div><!-- end col -->
            </div>
            ...
            <div class="row">
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover" src="{{ URL::asset('2_AdminPanel/images/small/img-12.jpg') }}" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-header">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img class="rounded-start img-fluid h-100 object-cover" src="{{ URL::asset('2_AdminPanel/images/small/img-9.jpg') }}" alt="Card image">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img class="rounded-end img-fluid h-100 object-cover" src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt="Card image">
                            </div>
                        </div>
                    </div><!-- end card -->
                </div><!-- end col -->
                ...
                <div class="col-xxl-4">
                    <div class="card card-success">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" alt="" class="avatar-sm rounded-circle">
                                </div>
                                <div class="flex-grow-1 ms-3">
        ...
        <div class="col-xxl-4">
            <div class="card card-secondary">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-7.jpg') }}" alt="" class="avatar-sm rounded-circle">
                        </div>
                        <div class="flex-grow-1 ms-3">
        ...
        <div class="col-xxl-4">
            <div class="card card-light">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-8.jpg') }}" alt="" class="avatar-sm rounded-circle">
                        </div>
                        <div class="flex-grow-1 ms-3">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-group">
                <div class="card mb-4">
                    <img class="card-img-top img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" alt="Card image cap" />
                    <div class="card-body">
            ...
            <div class="card mb-4">
                <img class="card-img-top img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" alt="Card image cap" />
                <div class="card-body">
    ...
    <div class="row g-3">
        ...
        <div class="col-xxl col-6">
            <div class="card h-100">
                ...
                <img class="img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-11.jpg') }}" alt="Card image cap" />
                <div class="card-body">
        ...
        <div class="col-xxl col-6">
            <div class="card h-100">
                <img class="card-img-top img-fluid" src="{{ URL::asset('2_AdminPanel/images/small/img-10.jpg') }}" alt="Card image cap" />
                <div class="card-body">
                    <h4 class="card-title">Give your text a good structure?</h4>
                    <p class="card-text">This is a wider card with supporting text below as
                        a natural lead-in to additional content. This card has even longer
        ...
        <div class="col-sm-12">
            ...
            <div class="row" data-masonry='{"percentPosition": true }'>
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" class="card-img-top" alt="..." />
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card">
                        <img src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" class="card-img" alt="..." />
                    </div>
                </div><!-- end col -->
                <div class="col-sm-6 col-lg-4">
                    <div class="card p-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex position-relative">
                                <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" class="flex-shrink-0 me-3 avatar-xl rounded" alt="..." />
                                <div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-0 bg-light position-relative">
                                <div class="col-md-5">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" class="rounded-start img-fluid" alt="..." />
                                </div>
    ...
    @endsection
    @section('script')
        <script src="{{ URL::asset('2_AdminPanel/libs/masonry-layout/masonry.pkgd.min.js') }}"></script>
        <script src="{{ URL::asset('2_AdminPanel/js/pages/card.init.js') }}"></script>
        <script src="{{ URL::asset('2_AdminPanel/libs/prismjs/prism.js') }}"></script>
