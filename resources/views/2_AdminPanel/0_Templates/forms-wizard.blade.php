                            ...
                            <div>
                                <div class="text-center">
                                    <div class="profile-user position-relative d-inline-block mx-auto mb-2">
                                        <img src="{{URL::asset('2_AdminPanel/images/users/user-dummy-img.jpg')}}" class="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="user-profile-image">
...
@endsection
@section('script')
<script src="{{ URL::asset('2_AdminPanel/js/pages/form-wizard.init.js') }}"></script>
