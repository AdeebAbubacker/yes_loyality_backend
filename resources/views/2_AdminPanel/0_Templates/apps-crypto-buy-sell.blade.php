                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/xmr.svg') }}" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/sol.svg') }}" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/ant.svg') }}" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/fil.svg') }}" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/aave.svg') }}" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/ada.svg') }}" alt=""
                                        class="avatar-xxs me-2">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center fw-medium">
                                    <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/dot.svg') }}" alt=""
                                        class="avatar-xxs me-2">
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/crypto-buy-sell.init.js') }}"></script>
