                    ...
                    <div class="swiper default-swiper rounded">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-1.jpg') }}" alt="" class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}" alt="" class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="" class="img-fluid" />
                            </div>
                        </div>
                    </div>
                </div><!-- end card-body -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="swiper navigation-swiper rounded">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" alt="" class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" alt="" class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" alt="" class="img-fluid" />
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="swiper pagination-dynamic-swiper rounded">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" alt="" class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-8.jpg') }}" alt="" class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-9.jpg') }}" alt="" class="img-fluid" />
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="swiper pagination-fraction-swiper rounded">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-10.jpg') }}" alt="" class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-11.jpg') }}" alt="" class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-12.jpg') }}" alt="" class="img-fluid" />
                            </div>
                        </div>
                        <div class="swiper-button-next"></div>
                        <div class="swiper-button-prev"></div>
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/swiper.init.js') }}"></script>
