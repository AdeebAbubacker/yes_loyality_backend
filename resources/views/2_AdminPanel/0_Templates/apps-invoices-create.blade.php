...
<!-- Sweet Alert css-->
<link href="{{ URL::asset('2_AdminPanel/libs/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet">
                            ...
                            <div class="profile-user mx-auto  mb-3">
                                ...
                                <label for="profile-img-file-input" class="d-block" tabindex="0">
                                    <span class="overflow-hidden border border-dashed d-flex align-items-center justify-content-center rounded" style="height: 60px; width: 256px;">
                                        <img src="{{ URL::asset('2_AdminPanel/images/logo-dark.png') }}" class="card-logo card-logo-dark user-profile-image img-fluid" alt="logo dark">
                                        <img src="{{ URL::asset('2_AdminPanel/images/logo-light.png') }}" class="card-logo card-logo-light user-profile-image img-fluid" alt="logo light">
                                    </span>
                                </label>
                            </div>
                            <div>
...
<script src="{{ URL::asset('2_AdminPanel/js/pages/invoicecreate.init.js') }}"></script>
