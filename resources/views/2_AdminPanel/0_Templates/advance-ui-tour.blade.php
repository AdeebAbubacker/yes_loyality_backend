...
@section('css')
    <link href="{{ URL::asset('2_AdminPanel/libs/shepherd.js/css/shepherd.css')}}" rel="stylesheet" type="text/css" />
                            ...
                            <div class="col-lg-5">
                                <div class="text-center mt-4 mb-5">
                                    <div class="py-3 px-2 d-inline-block" id="logo-tour">
                                        <img src="{{ URL::asset('2_AdminPanel/images/logo-dark.png') }}" class="card-logo card-logo-dark" alt="logo" height="17">
                                        <img src="{{ URL::asset('2_AdminPanel/images/logo-light.png') }}" class="card-logo card-logo-light" alt="logo" height="17">
                                    </div>
...
@endsection
@section('script')
    <script src="{{ URL::asset('2_AdminPanel/libs/shepherd.js/js/shepherd.min.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/js/pages/tour.init.js') }}"></script>
