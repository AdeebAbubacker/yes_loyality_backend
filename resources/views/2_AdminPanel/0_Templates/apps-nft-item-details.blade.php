                                    ...
                                    <table class="table align-middle table-nowrap mb-0">
                                        <tbody>
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-01.jpg')}}" alt="" class="avatar-xs rounded object-cover" />
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-1.jpg')}}" alt="" class="avatar-xs rounded object-cover" />
                                                        <div class="ms-2">
                                                            <a href="#!">
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-03.jpg')}}" alt="" class="avatar-xs rounded object-cover" />
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-3.jpg')}}" alt="" class="avatar-xs rounded object-cover" />
                                                        <div class="ms-2">
                                                            <a href="#!">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-5.jpg')}}" alt="" class="avatar-xs rounded object-cover" />
                                                        <div class="ms-2">
                                                            <a href="#!">
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{URL::asset('2_AdminPanel/images/nft/img-06.jpg')}}" alt="" class="avatar-xs rounded object-cover" />
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{URL::asset('2_AdminPanel/images/users/avatar-8.jpg')}}" alt="" class="avatar-xs rounded object-cover" />
                                                        <div class="ms-2">
                                                            <a href="#!">
                                                ...
                                                <div class="border border-dashed rounded p-3">
                                                    ...
                                                    <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                        <a href="#" class="d-block">
                                                            <img src="{{URL::asset('2_AdminPanel/images/small/img-12.jpg')}}" alt="" class="avatar-sm rounded object-cover" />
                                                        </a>
                                                        <a href="#" class="d-block">
                                                            <img src="{{URL::asset('2_AdminPanel/images/small/img-11.jpg')}}" alt="" class="avatar-sm rounded object-cover" />
                                                        </a>
                                                        <a href="#" class="d-block">
                                                            <img src="{{URL::asset('2_AdminPanel/images/small/img-10.jpg')}}" alt="" class="avatar-sm rounded object-cover" />
                                                        </a>
                                                    </div>
...
@endsection
@section('script')
<script src="{{ URL::asset('2_AdminPanel/js/pages/apps-nft-item-details.init.js') }}"></script>
