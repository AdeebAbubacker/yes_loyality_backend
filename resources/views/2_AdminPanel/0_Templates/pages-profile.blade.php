...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ URL::asset('2_AdminPanel/libs/swiper/swiper-bundle.min.css') }}">
@endsection
@section('content')

    <div class="profile-foreground position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg">
            <img src="{{ URL::asset('2_AdminPanel/images/profile-bg.jpg') }}" alt="" class="profile-wid-img" />
        </div>
    </div>
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
                    <img src="@if (Auth::user()->avatar != '') {{ URL::asset('3_FileUploads/1_UserAvatars/' . Auth::user()->avatar) }}@else{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }} @endif"
                                        ...
                                        <div>
                                            <div class="d-flex align-items-center py-3">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" alt=""
                                            ...
                                            <div class="d-flex align-items-center py-3">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt=""
                                                        class="img-fluid rounded-circle" />
                                                </div>
                                                <div class="flex-grow-1">
                                                    <div>
                                            ...
                                            <div class="d-flex align-items-center py-3">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-5.jpg') }}" alt=""
                                                        class="img-fluid rounded-circle" />
                                                </div>
                                                <div class="flex-grow-1">
                                                    <div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" alt=""
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" alt=""
                                                    height="50" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" alt=""
                                                    height="50" class="rounded" />
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                                                            ...
                                                                            <div class="row mt-2">
                                                                                <div class="col-xxl-6">
                                                                                    <div
                                                                                        ...
                                                                                        <div class="col-3">
                                                                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}"
                                                                                                alt=""
                                                                                                class="img-fluid rounded" />
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}"
                                                                                                alt=""
                                                                                                class="img-fluid rounded" />
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}"
                                                                                                alt=""
                                                                                                class="img-fluid rounded" />
                                                                                        </div>
                                                                                        <!--end col-->
                                                                                        <div class="col-3">
                                                                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-9.jpg') }}"
                                                                                                alt=""
                                                                                                class="img-fluid rounded" />
                                                                                        </div>
                                                                                        <!--end col-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="acitivity-timeline">
                                    <div class="acitivity-item d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" alt=""
                                            ...
                                            <div class="row">
                                                <div class="col-xxl-4">
                                                    <div class="row border border-dashed gx-2 p-2 mb-2">
                                                        <div class="col-4">
                                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-2.jpg') }}"
                                                        ...
                                                        <!--end col-->
                                                        <div class="col-4">
                                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}"
                                                                alt="" class="img-fluid rounded" />
                                                        </div>
                                                        <!--end col-->
                                                    </div>
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-6.jpg') }}" alt=""
                                                class="avatar-xs rounded-circle acitivity-avatar" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-7.jpg') }}" alt=""
                                                class="avatar-xs rounded-circle acitivity-avatar" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="acitivity-item d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-8.jpg') }}" alt=""
                                                class="avatar-xs rounded-circle acitivity-avatar" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div class="avatar-group">
                                                                <div class="avatar-group-item">
                                                                    <div class="avatar-xs">
                                                                        <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}"
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/profile.init.js') }}"></script>
