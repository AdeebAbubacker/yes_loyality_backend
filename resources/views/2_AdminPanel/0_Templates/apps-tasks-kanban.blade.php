...
@section('css')
    <link href="{{ URL::asset('2_AdminPanel/libs/dragula/dragula.min.css') }}" rel="stylesheet">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="avatar-group">
                                        <a href="javascript: void(0);" class="avatar-group-item"
                                            ...
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-9.jpg') }}" alt=""
                                                class="rounded-circle avatar-xxs">
                                        </a>
                                        <a href="javascript: void(0);" class="avatar-group-item"
                                            data-bs-toggle="tooltip" data-bs-trigger="hover"
...
@endsection
@section('script')
    <script src="{{ URL::asset('2_AdminPanel/libs/dragula/dragula.min.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/libs/dom-autoscroller/dom-autoscroller.min.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/js/pages/tasks-kanban.init.js') }}"></script>
