                            ...
                            <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                    <div class="d-flex mb-2">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-4.jpg') }}" alt="" width="150" class="rounded">
                                        </div>
                                ...
                                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                    <div class="d-flex mb-2">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-5.jpg') }}" alt="" width="150" class="rounded">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                    <div class="d-flex mb-2">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-6.jpg') }}" alt="" width="150" class="rounded">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                    <div class="d-flex mb-2">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-7.jpg') }}" alt="" width="150" class="rounded">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="home2" role="tabpanel">
                            <p class="flex-grow-1 mb-0"><img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" alt="" class="avatar-lg rounded float-start me-3">
                        ...
                        <div class="tab-pane active" id="developers" role="tabpanel">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-8.jpg') }}" alt="" class="avatar-sm rounded" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mt-3">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-7.jpg') }}" alt="" class="avatar-sm rounded" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mt-3">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-6.jpg') }}" alt="" class="avatar-sm rounded" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="d-flex mt-3 mt-sm-0">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-5.jpg') }}" alt="" class="avatar-sm rounded" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex mt-3">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt="" class="avatar-sm rounded" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                        ...
                        <div class="tab-pane" id="designers" role="tabpanel">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" alt="" class="avatar-sm rounded" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                        ...
                        <div class="col-lg-9">
                            <div class="tab-content text-muted mt-3 mt-lg-0">
                                ...
                                <div class="tab-pane fade" id="custom-v-pills-profile" role="tabpanel" aria-labelledby="custom-v-pills-profile-tab">
                                    <div class="d-flex mb-4">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-3.jpg') }}" alt="" width="150" class="rounded">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <div class="tab-pane fade" id="custom-v-pills-messages" role="tabpanel" aria-labelledby="custom-v-pills-messages-tab">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('2_AdminPanel/images/small/img-8.jpg') }}" alt="" width="150" class="rounded">
                                        </div>
                                    </div>
                                </div><!--end tab-pane-->
                            </div>
                    ...
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="nav-colored-home" role="tabpanel">
                            <div class="d-flex mb-3">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-2.jpg') }}" alt="" class="avatar-md rounded">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    Food truck fixie locavore, accusamus mcsweeney's marfa nulla
                                    single-origin coffee squid. Exercitation +1 labore velit, blog
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-3.jpg') }}" alt="" class="avatar-md rounded">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="nav-colored-profile" role="tabpanel">
                            <div class="d-flex mb-3">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-4.jpg') }}" alt="" class="avatar-md rounded">
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('2_AdminPanel/images/users/avatar-1.jpg') }}" alt="" class="avatar-md rounded">
                                </div>
                            </div>
                        </div>
