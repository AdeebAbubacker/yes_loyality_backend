@extends('2_AdminPanel.1_Layouts.1_MainLayout-layouts')
@section('title') @lang('translation.horizontal') @endsection
@section('css')
    <link href="{{ URL::asset('2_AdminPanel/libs/jsvectormap/css/jsvectormap.min.css') }}" rel="stylesheet">
@endsection
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="px-3">
                                            <img src="{{ URL::asset('2_AdminPanel/images/user-illustarator-2.png') }}"
                                                class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <div class="text-center">
                                <img src="{{ URL::asset('2_AdminPanel/images/illustrator-1.png') }}" class="img-fluid" alt="">
                            </div>
                        </div><!-- end col -->
                    </div><!-- end row -->
                    <div class="mt-3 pt-2">
...
@section('script')
    ...
    <script src="{{ URL::asset('2_AdminPanel/js/pages/dashboard-analytics.init.js') }}"></script>
