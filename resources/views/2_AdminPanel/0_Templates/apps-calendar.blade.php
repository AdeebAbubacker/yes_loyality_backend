...
@section('css')
    <link href="{{ URL::asset('2_AdminPanel/libs/fullcalendar/main.min.css') }}" rel="stylesheet">
@endsection
@section('content')
...
@endsection
@section('script')
    <script src="{{ URL::asset('2_AdminPanel/libs/fullcalendar/main.min.js') }}"></script>
    <script src="{{ URL::asset('2_AdminPanel/js/pages/calendar.init.js') }}"></script>
