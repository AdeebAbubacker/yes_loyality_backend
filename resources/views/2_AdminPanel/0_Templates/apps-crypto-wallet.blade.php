                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/btc.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/ltc.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/eth.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/xmr.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/dash.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/mkr.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                ...
                <div class="swiper-slide">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/neo.svg') }}" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <tbody class="list form-check-all">
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/btc.svg') }}" alt="" class="avatar-xxs me-2" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/eth.svg') }}" alt="" class="avatar-xxs me-2" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/xrp.svg') }}" alt="" class="avatar-xxs me-2" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/xmr.svg') }}" alt="" class="avatar-xxs me-2" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/ltc.svg') }}" alt="" class="avatar-xxs me-2" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/aave.svg') }}" alt="" class="avatar-xxs me-2" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/mkr.svg') }}" alt="" class="avatar-xxs me-2" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center fw-medium">
                                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/yfi.svg') }}" alt="" class="avatar-xxs me-2" />
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex mb-3">
                    <div class="flex-shrink-0">
                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/btc.svg') }}" alt="" class="avatar-xxs" />
                    </div>
                ...
                <div class="d-flex mb-3">
                    <div class="flex-shrink-0">
                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/ltc.svg') }}" alt="" class="avatar-xxs" />
                    </div>
                    <div class="flex-grow-1 ms-3">
                ...
                <div class="d-flex mb-3">
                    <div class="flex-shrink-0">
                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/xmr.svg') }}" alt="" class="avatar-xxs" />
                    </div>
                    <div class="flex-grow-1 ms-3">
                ...
                <div class="d-flex mb-3">
                    <div class="flex-shrink-0">
                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/fil.svg') }}" alt="" class="avatar-xxs" />
                    </div>
                    <div class="flex-grow-1 ms-3">
                ...
                <div class="d-flex mb-3">
                    <div class="flex-shrink-0">
                        <img src="{{ URL::asset('2_AdminPanel/images/svg/crypto-icons/dot.svg') }}" alt="" class="avatar-xxs" />
                    </div>
                    <div class="flex-grow-1 ms-3">
...
@endsection
@section('script')
<script src="{{ URL::asset('2_AdminPanel/libs/list.js/list.min.js') }}"></script>
<script src="{{ URL::asset('2_AdminPanel/libs/list.pagination.js/list.pagination.min.js') }}"></script>
...
<script src="{{ URL::asset('2_AdminPanel/js/pages/crypto-wallet.init.js') }}"></script>
