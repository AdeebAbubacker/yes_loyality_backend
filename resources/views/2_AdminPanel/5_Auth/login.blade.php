            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to Yes Yes Loyalty Admin Section.</p>
                                </div>
                                <div class="p-2 mt-4">
                        ...
                        <div class="mt-4 text-center">
                        <p class="mb-0">Get Support ? <a href="{{ route('SupportPageOuter') }}" class="fw-semibold text-primary text-decoration-none"> Click here </a> </p>
                    </div>
                ...
                <!-- end row -->
                {{-- <div class="mt-4 text-center">
                    <p class="mb-0">Already have an account ? <a href="{{ route('RegisterView') }}"
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; {{ date('Y') }} Designed & Developed by <a
                                    href="https://agatebc.com/" class="new-tab-link" target="_blank" rel="noopener noreferrer">Agate Business
                                    Consulting</a></p>
