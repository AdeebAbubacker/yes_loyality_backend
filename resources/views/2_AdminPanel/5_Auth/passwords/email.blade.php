                                                    ...
                                                    <div class="d-flex flex-column h-100">
                                                        <div class="mb-4 mb-md-5">
                                                            <a href="/index" class="d-block auth-logo">
                                                                <img src="{{URL::asset('2_AdminPanel/images/logo-dark.png')}}" alt="" height="22" class="auth-logo-dark me-start">
                                                                <img src="{{URL::asset('2_AdminPanel/images/logo-light.png')}}" alt="" height="22" class="auth-logo-light me-start">
                                                            </a>
                                                        </div>
...
@endsection
@section('script')
    <script src="{{ URL::asset('2_AdminPanel/js/pages/eva-icon.init.js') }}"></script>
@endsection
