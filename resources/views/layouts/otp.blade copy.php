    ...
    <div style="
      ...
      ">
        <header>
            <table style="width: 100%;">
                <tbody>
                    <tr style="height: 0;">
                        <td>
                            <img alt="" src="https://yesyesloyalty.agatebc.in/2_AdminPanel/images//YL-logo.png" height="30px" />
                        </td>
                        <td style="text-align: right;">
                            <span style="font-size: 16px; line-height: 30px; color: #ffffff;">{{ $currentDate->format('F j, Y') }}</span>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <main>
          ...
          ">
                Need help? Ask at
                <a href="mailto:info@yesyesindiansupermarket.com.au" style="color: #499fb6; text-decoration: none;">info@yesyesindiansupermarket.com.au</a>
                or visit our
