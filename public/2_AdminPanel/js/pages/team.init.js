        ...
        elem.addEventListener('click', function (event) {
            ...
            allmemberlist = allmemberlist.map(function (item) {
                if (item.id == getEditid) {
                    ...
                    if(item.memberImg == ""){
                        document.getElementById("member-img").src = "/2_AdminPanel/images/users/user-dummy-img.jpg";
                    }else{
...
Array.from(document.querySelectorAll(".addMembers-modal")).forEach(function (elem) {
    elem.addEventListener('click', function (event) {
      ...
      document.getElementById("cover-img").src = "/2_AdminPanel/images/small/img-9.jpg";
      document.getElementById("member-img").src = "/2_AdminPanel/images/users/user-dummy-img.jpg";
        ...
        .forEach(function (form) {
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    if(memberImgValue == "/2_AdminPanel/images/users/user-dummy-img.jpg"){
                        memberImageValue = ""
                    }else{
    ...
    Array.from(document.querySelectorAll(".team-box")).forEach(function (item) {
        item.querySelector(".member-name").addEventListener("click", function () {
            ...
            if(item.querySelector(".member-img")){
                ...
                memberProfileImg = "/2_AdminPanel/images/users/user-dummy-img.jpg"
            }
