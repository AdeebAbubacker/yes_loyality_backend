...
(function () {
    var dummyUserImage = "/2_AdminPanel/images/users/user-dummy-img.jpg";
    var dummyMultiUserImage = "/2_AdminPanel/images/users/multi-user.jpg";
    ...
    var emojiPicker = new FgEmojiPicker({
        ...
        position: ["top", "right"],
        preFetch: true,
        dir: "/2_AdminPanel/js/pages/plugins/json",
