...
function setLanguage(lang) {
	if (document.getElementById("header-lang-img")) {
		if (lang == "en") {
			document.getElementById("header-lang-img").src = "/2_AdminPanel/images/flags/us.svg";
		} else if (lang == "sp") {
			document.getElementById("header-lang-img").src = "/2_AdminPanel/images/flags/spain.svg";
		} else if (lang == "gr") {
			document.getElementById("header-lang-img").src = "/2_AdminPanel/images/flags/germany.svg";
		} else if (lang == "it") {
			document.getElementById("header-lang-img").src = "/2_AdminPanel/images/flags/italy.svg";
		} else if (lang == "ru") {
			document.getElementById("header-lang-img").src = "/2_AdminPanel/images/flags/russia.svg";
		} else if (lang == "ch") {
			document.getElementById("header-lang-img").src = "/2_AdminPanel/images/flags/china.svg";
		} else if (lang == "fr") {
			document.getElementById("header-lang-img").src = "/2_AdminPanel/images/flags/french.svg";
		} else if (lang == "ar") {
			document.getElementById("header-lang-img").src = "/2_AdminPanel/images/flags/ae.svg";
		}
...
function getLanguage() {
	...
	request.open("GET", "/2_AdminPanel/lang/" + language + ".json");
...
function twoColumnMenuGenerate() {
	...
	if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
		...
		ul.innerHTML = '<a href="#" class="logo"><img src="/2_AdminPanel/images/logo-sm.png" alt="" height="22"></a>';
				...
				if (elem.querySelectorAll(".notification-item").length > 0) {
					...
					if (!emptyNotificationElem) {
						...
						<div class="w-25 w-sm-50 pt-3 mx-auto">\
							<img src="/2_AdminPanel/images/svg/bell.svg" class="img-fluid" alt="user-pic">\
						</div>\
...
function activateParentNavItems() {
	var activeNavItem = $('#navbar-nav li a.active');

	// Loop through each parent li element and add the active class
	activeNavItem.parents('li.nav-item').each(function () {
		$(this).removeClass('collapsed').attr('aria-expanded', 'true');
		$(this).children('a.nav-link').removeClass('collapsed').addClass('active').attr('aria-expanded', 'true');
		$(this).children('.menu-dropdown').addClass('show');
	});
}

// ===============================
// Chat GPT Code.. Modify & Use..
// ===============================

// function activateParentNavItems() {
// 	var activeNavLink = document.querySelector('#navbar-nav li a.active');
  
// 	// Loop through each parent li element and add the active class
// 	var parentNavItem = activeNavLink.parentElement;
// 	while (parentNavItem && parentNavItem.tagName === 'LI' && parentNavItem.classList.contains('nav-item')) {
// 	  parentNavItem.classList.add('active');
// 	  parentNavItem.classList.remove('collapsed');
// 	  parentNavItem.setAttribute('aria-expanded', 'true');
  
// 	  var childNavLink = parentNavItem.querySelector('a.nav-link');
// 	  if (childNavLink) {
// 		childNavLink.classList.add('active');
// 		childNavLink.classList.remove('collapsed');
// 		childNavLink.setAttribute('aria-expanded', 'true');
// 	  }
  
// 	  var menuDropdown = parentNavItem.querySelector('.menu-dropdown');
// 	  if (menuDropdown) {
